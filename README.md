...
<center><img src="./images/LAPTOP.png" width="25%" /> </center>
<center>**Figure 1.** Three VMs should be set up in total, with one acting as a gateway and the other two running the Ceph cluster.</center>
