...
---------------------------
All the mgr modules share a cache that is enabled by default. The cache
...
approximate size of 4MiB. With heavy load, on a 3000 OSD cluster there has
been a 1.5x improvement with the cache enabled.
...
you'll find the hit/miss ratio of the mgr cache, which can help verify the
