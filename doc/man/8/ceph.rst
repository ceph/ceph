 ...
 * histogram_name - Performance histogram name, list of possible values is available via 'ceph daemon <daemon_name> perf histogram schema' command
...
Example::
	...
	ceph daemonhistogram osd.all op_w_latency_in_bytes_histogram live 5 12
	ceph daemonhistogram osd.1,osd.3,osd.5 op_r_latency_out_bytes_histogram batch 2
