...
The cephx IDs authorized to the old file system name need to be re-authorized
to the new name. The on-going operations of the clients using these IDs will be
