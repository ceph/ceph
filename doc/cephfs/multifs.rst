...
In case the data and/or metadata pools for the volume/CephFS that needs to be
created are already present, name(s) of these pools can be passed as follows::
