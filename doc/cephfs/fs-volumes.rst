...
.. prompt:: bash #
   ...
   ceph fs subvolume create <vol_name> <subvol_name> [--size <size_in_bytes>] [--group_name <subvol_group_name>] [--pool_layout <data_pool_name>] [--uid <uid>] [--gid <gid>] [--mode <octal_mode>] [--namespace-isolated] [--earmark <earmark>] [--normalization <form>] [--case_insensitive]
...
the ``--case_insensitive`` option is used. When this option is added, file
...
.. note:: Setting ``--case_insensitive`` option implicitly enables
