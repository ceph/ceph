...
See :ref:`Crimson's User Guide <crimson_doc>` for more information.
...
.. note::
   `vstart.sh`_ enables crimson :ref:`crimson-required-flags` automatically when `--crimson` is used.
