...
In Client::_do_setattr(), it does not expliclty send the MDS new change_attr
...
so maybe things work out anyway? It's certainly quite a narrow inaccuracy.)
