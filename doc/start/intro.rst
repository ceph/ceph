...
:term:`CRUSH` algorithm, Ceph calculates which placement group should contain
the object, and calculates which Ceph OSD Daemon should store the placement
group. The CRUSH algorithm enables the Ceph Storage Cluster to scale,
rebalance, and recover dynamically.
