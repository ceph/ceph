...
|                      | maintained a community in Slack. Ask your       | - `Ceph Slack Invite`_                        |
|                      | Ceph-related questions in Ceph's Slack channels.|                                               |
+----------------------+-------------------------------------------------+-----------------------------------------------+
...
|                      | of the email list at any time by unsubscribing. | - `QA Archives`_                              |
...
|                      | opt out of the email list at any time by        | - `Community Archives`_                       |
|                      | unsubscribing. A simple email is all it takes!  |                                               |
+----------------------+-------------------------------------------------+-----------------------------------------------+
...
|                      | at https://github.com. See `Ceph Source Code`_  |                                               |
|                      | for details on cloning from github.             |                                               |
+----------------------+-------------------------------------------------+-----------------------------------------------+
| **Ceph Calendar**    | Learn about upcoming Ceph events.               | https://ceph.io/en/community/events/          |
+----------------------+-------------------------------------------------+-----------------------------------------------+
| **Contribute to      | Learn about contributing to Ceph.               | https://ceph.io/contribute/                   |
| Ceph**               |                                                 |                                               |
+----------------------+-------------------------------------------------+-----------------------------------------------+


.. _Blog: https://ceph.io/en/news/blog/
.. _Ceph Slack Invite: https://join.slack.com/t/ceph-storage/shared_invite/zt-3rnjcbcwx-xaXanGXV6B8eo58e69Tjlw
...
.. _Kernel Client Subscribe: mailto:ceph-devel+subscribe@vger.kernel.org?body=subscribe+ceph-devel
.. _Kernel Client Unsubscribe: mailto:ceph-devel+unsubscribe@vger.kernel.org?body=unsubscribe+ceph-devel
.. _Kernel Client Archives: https://lore.kernel.org/ceph-devel/
.. _QA Subscribe: https://lists.ceph.io/postorius/lists/ceph-qa.ceph.io/
.. _QA Archives: https://lists.ceph.io/hyperkitty/list/ceph-qa@ceph.io/
.. _Community Subscribe: https://lists.ceph.io/postorius/lists/community.ceph.io/
.. _Community Archives: https://lists.ceph.io/hyperkitty/list/community@ceph.io/
.. _Tracker: https://tracker.ceph.com/
.. _Ceph Source Code: https://github.com/ceph/ceph
