...
.. list-table::
   ...
   * - **User List**
     ...
     - - `User Subscribe`_
       - `User Archives`_
   * - **Devel List**
     - Development discussion (dev@ceph.io).
     - - `Devel Subscribe`_
       - `Devel Archives`_
   * - **Kernel Client**
   ...
   * - **QA List**
     ...
     - `QA Subscribe`_
   * - **Community List**
     - Ceph User Committee and community topics.
     - - `Community Subscribe`_
       - `Community Archives`_
   * - **Bug Tracker**
   ...
   * - **Ceph Calendar**
     - Upcoming events.
     - https://ceph.io/en/community/events/
   * - **Contribute to Ceph**
     - How to contribute.
     - https://ceph.io/contribute/
