...
* :ref:`mon_osd_cache_size`
* :ref:`rocksdb_cache_size`
...
the OSD attempts to consume with the :ref:`osd_memory_target` configuration
option.

- Setting the :ref:`osd_memory_target` below 2GB is typically not
...
- 4GB is the current default :ref:`osd_memory_target` size.  This default
  was chosen for typical use cases, and is intended to balance memory
  requirements and OSD performance for typical use cases.

- Setting the :ref:`osd_memory_target` higher than 4GB can improve
