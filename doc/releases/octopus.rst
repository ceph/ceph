...
* build/ops,rbd: rpm,deb: fix python dateutil module dependency (`pr#33624 <https://github.com/ceph/ceph/pull/33624>`_, Mykola Golu)
...
* doc: document mode param for rbd mirror image enable command (`pr#32735 <https://github.com/ceph/ceph/pull/32735>`_, Mykola Golu)
...
* librbd: always try to acquire exclusive lock when removing image (`pr#29775 <https://github.com/ceph/ceph/pull/29775>`_, Mykola Golu)
...
* librbd: behave more gracefully when data pool removed (`pr#29613 <https://github.com/ceph/ceph/pull/29613>`_, Mykola Golu)
...
* librbd: clone copy-on-write operations should preserve sparseness (`pr#27999 <https://github.com/ceph/ceph/pull/27999>`_, Mykola Golu)
...
* librbd: dispatch delayed requests only if read intersects (`pr#27446 <https://github.com/ceph/ceph/pull/27446>`_, Mykola Golu)
* librbd: do not allow to deep copy migrating image (`pr#27194 <https://github.com/ceph/ceph/pull/27194>`_, Mykola Golu)
...
* librbd: dont call refresh from mirror::GetInfoRequest state machine (`pr#32734 <https://github.com/ceph/ceph/pull/32734>`_, Mykola Golu)
* librbd: dont use complete_external_callback if ImageCtx destroyed (`pr#29263 <https://github.com/ceph/ceph/pull/29263>`_, Mykola Golu)
* librbd: explicitly specify mode on mirror image enable (`pr#32217 <https://github.com/ceph/ceph/pull/32217>`_, Mykola Golu)
...
* librbd: fix build on freebsd (`pr#32938 <https://github.com/ceph/ceph/pull/32938>`_, Mykola Golu)
...
* librbd: fix potential snapshot remove failure due to duplicate RPC messages (`pr#32760 <https://github.com/ceph/ceph/pull/32760>`_, Mykola Golu)
...
* librbd: fix some edge cases for snapshot mirror mode promote (`pr#32567 <https://github.com/ceph/ceph/pull/32567>`_, Mykola Golu)
* librbd: fix typo in deep_copy::ObjectCopyRequest::compute_read_ops (`pr#27049 <https://github.com/ceph/ceph/pull/27049>`_, Mykola Golu)
...
* librbd: leak on canceling simple io scheduler timer task (`pr#27755 <https://github.com/ceph/ceph/pull/27755>`_, Mykola Golu)
* librbd: look for mirror peers in default namespace (`pr#32338 <https://github.com/ceph/ceph/pull/32338>`_, Mykola Golu)
* librbd: look for pool metadata in default namespace (`pr#27151 <https://github.com/ceph/ceph/pull/27151>`_, Mykola Golu)
* librbd: make flush be queued by QOS throttler (`pr#26931 <https://github.com/ceph/ceph/pull/26931>`_, Mykola Golu)
* librbd: mirror image enable/disable should enable/disable journaling (`pr#28553 <https://github.com/ceph/ceph/pull/28553>`_, Mykola Golu)
...
* librbd: optionally move parent image to trash on remove (`pr#27521 <https://github.com/ceph/ceph/pull/27521>`_, Mykola Golu)
...
* librbd: simple scheduler plugin for object dispatcher layer (`pr#26675 <https://github.com/ceph/ceph/pull/26675>`_, Mykola Golu)
...
* librbd: support EC data pool images sparsify (`pr#27268 <https://github.com/ceph/ceph/pull/27268>`_, Mykola Golu)
* librbd: support zero-copy writes via the C API (`pr#27895 <https://github.com/ceph/ceph/pull/27895>`_, Jason Dillaman)
* librbd: trash move return EBUSY instead of EINVAL for migrating image (`pr#27136 <https://github.com/ceph/ceph/pull/27136>`_, Mykola Golu)
...
* librbd: when unlinking peer from mirror snaps do it in all namespaces (`pr#32463 <https://github.com/ceph/ceph/pull/32463>`_, Mykola Golu)
...
* mgr,rbd: mgr/rbd_support: dont scan pools that dont have schedules (`pr#33840 <https://github.com/ceph/ceph/pull/33840>`_, Mykola Golu)
* mgr,rbd: mgr/rbd_support: implement mirror snapshot scheduler (`pr#32434 <https://github.com/ceph/ceph/pull/32434>`_, Mykola Golu)
...
* mgr,rbd: pybind/mgr: fix format for rbd-mirror prometheus metrics (`pr#28200 <https://github.com/ceph/ceph/pull/28200>`_, Mykola Golu)
...
* mgr: mgr/balancer: python3 compatibility issue (`pr#30987 <https://github.com/ceph/ceph/pull/30987>`_, Mykola Golu)
...
* osd: fix possible crash on sending dynamic perf stats report (`pr#30454 <https://github.com/ceph/ceph/pull/30454>`_, Mykola Golu)
...
* rbd,tests: qa/workunits/rbd: fix compare_images and compare_image_snapshots (`pr#28524 <https://github.com/ceph/ceph/pull/28524>`_, Mykola Golu)
...
* rbd,tests: qa/workunits/rbd: stress test `rbd mirror pool status --verbose` (`pr#29655 <https://github.com/ceph/ceph/pull/29655>`_, Mykola Golu)
...
* rbd,tests: qa: add RBD QOS functional test (`pr#27137 <https://github.com/ceph/ceph/pull/27137>`_, Mykola Golu)
...
* rbd,tests: test/librbd: fix mock warnings in TestMockIoImageRequest (`pr#31497 <https://github.com/ceph/ceph/pull/31497>`_, Mykola Golu)
...
* rbd,tests: test/pybind: inconsistent use of tabs and spaces in indentation (`pr#31606 <https://github.com/ceph/ceph/pull/31606>`_, Mykola Golu)
* rbd,tests: test/rbd_mirror: fix mock warnings (`pr#31608 <https://github.com/ceph/ceph/pull/31608>`_, Mykola Golu)
* rbd,tests: test/run-rbd-tests: properly initialize newly created rbd pool (`pr#33642 <https://github.com/ceph/ceph/pull/33642>`_, Mykola Golu)
...
* rbd-mirror: add namespace support (`issue#37529 <http://tracker.ceph.com/issues/37529>`_, `pr#28939 <https://github.com/ceph/ceph/pull/28939>`_, Mykola Golu)
* rbd-mirror: add namespace support to service daemon (`pr#31642 <https://github.com/ceph/ceph/pull/31642>`_, Mykola Golu)
...
* rbd-mirror: dont expect image map is always initialized (`pr#33368 <https://github.com/ceph/ceph/pull/33368>`_, Mykola Golu)
* rbd-mirror: dont overwrite status error returned by replay (`pr#28179 <https://github.com/ceph/ceph/pull/28179>`_, Mykola Golu)
...
* rbd-mirror: fix pool replayer status for case when init failed (`pr#32483 <https://github.com/ceph/ceph/pull/32483>`_, Mykola Golu)
* rbd-mirror: fix race on namespace replayer initialization failure (`pr#32243 <https://github.com/ceph/ceph/pull/32243>`_, Mykola Golu)
* rbd-mirror: handle duplicates in image sync throttler queue (`issue#40519 <http://tracker.ceph.com/issues/40519>`_, `pr#28730 <https://github.com/ceph/ceph/pull/28730>`_, Mykola Golu)
...
* rbd-mirror: improve detection of blacklisted state (`pr#33411 <https://github.com/ceph/ceph/pull/33411>`_, Mykola Golu)
...
* rbd-mirror: make logrotate work (`pr#32456 <https://github.com/ceph/ceph/pull/32456>`_, Mykola Golu)
* rbd-mirror: mirrored clone should be same format (`pr#31161 <https://github.com/ceph/ceph/pull/31161>`_, Mykola Golu)
...
* rbd-mirror: potential nullptr dereference in ImageReplayer::handle_start_replay (`pr#30484 <https://github.com/ceph/ceph/pull/30484>`_, Mykola Golu)
...
* rbd-mirror: removing non-primary trash snapshot (`pr#31260 <https://github.com/ceph/ceph/pull/31260>`_, Mykola Golu)
* rbd-mirror: rename per-image replication perf counters (`pr#32184 <https://github.com/ceph/ceph/pull/32184>`_, Mykola Golu)
* rbd-mirror: simplify peer bootstrapping (`pr#30411 <https://github.com/ceph/ceph/pull/30411>`_, Jason Dillaman)
* rbd-mirror: snapshot mirror mode (`pr#30548 <https://github.com/ceph/ceph/pull/30548>`_, Mykola Golu)
...
* rbd:  journal: add support for aligned appends (`pr#28351 <https://github.com/ceph/ceph/pull/28351>`_, Mykola Golu)
...
* rbd: add mirror snapshot schedule commands (`pr#32882 <https://github.com/ceph/ceph/pull/32882>`_, Mykola Golu)
...
* rbd: journal: fix race between player shut down and cache rebalance (`pr#28748 <https://github.com/ceph/ceph/pull/28748>`_, Mykola Golu)
* rbd: journal: fix race between player shut down and cache rebalance (`pr#29796 <https://github.com/ceph/ceph/pull/29796>`_, Mykola Golu)
* rbd: journal: optimize object overflow detection (`pr#28240 <https://github.com/ceph/ceph/pull/28240>`_, Mykola Golu)
* rbd: journal: properly advance read offset after skipping invalid range (`pr#28627 <https://github.com/ceph/ceph/pull/28627>`_, Mykola Golu)
* rbd: journal: return error after first corruption detected (`pr#28820 <https://github.com/ceph/ceph/pull/28820>`_, Mykola Golu)
* rbd: journal: wait for in flight advance sets on stopping recorder (`pr#28529 <https://github.com/ceph/ceph/pull/28529>`_, Mykola Golu)
...
* rbd: pybind/rbd: provide snap remove flags (`pr#31627 <https://github.com/ceph/ceph/pull/31627>`_, Mykola Golu)
...
* rbd: rbd-mirror: adjust journal fetch properties based on memory target (`pr#27670 <https://github.com/ceph/ceph/pull/27670>`_, Mykola Golu)
...
* rbd: schedule for running trash purge operations (`pr#33389 <https://github.com/ceph/ceph/pull/33389>`_, Mykola Golu)
