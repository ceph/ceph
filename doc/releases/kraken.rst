...
* bluestore: fix race condition during blob splitting (`pr#11422 <http://github.com/ceph/ceph/pull/11422>`_, xiexingguo, xie xingguo)
...
* bluestore: traverse buffer_map in reverse order when splitting BufferSpace (`pr#11468 <http://github.com/ceph/ceph/pull/11468>`_, xie xingguo)
...
* mon:  remove the redundant jugement in LogMonitor tick function (`pr#10474 <http://github.com/ceph/ceph/pull/10474>`_, song baisen)
...
* osd: remove redundant call of heartbeat_check (`pr#12130 <http://github.com/ceph/ceph/pull/12130>`_, Pan Liu)
...
* build/ops: verified f23 (`pr#10222 <http://github.com/ceph/ceph/pull/10222>`_, Kefu Chai)
...
* rgw: verified:  f23, subset of s3tests (`pr#10448 <http://github.com/ceph/ceph/pull/10448>`_, Pritha Srivastava)
