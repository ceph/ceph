...
Some exceptions exists to that rule, the "Failes Operation" columns in the table below indicate by "No" which operations will not fail even if logging failed.
...
+-------------------------------+-------------------------------------+------------------+
| Operation                     | Operation Name                      | Failes Operation |
+===============================+=====================================+==================+
