...
Cluster). You must create a user, access_key and secret_key to enable end users to
...
user.  You can specify a access_key and secret_key, or generate a access_key and secret_key
