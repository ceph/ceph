...
You don't need to trim usage log for specific subuser, trim usage logs of specific user
will trim all subusers' usage logs of that specific user.

.. caution:: user usage log and subuser usage log are maintained
             together, trim all users' usage log will also trim all
             subusers' usage log.
