...
.. note:: With default placement target settings, RGW stores an object's first data chunk in the RADOS "head" object along
          ...
          objects can be removed asynchronously in the background by garbage collection. **IMPORTANT** The inline data
          feature is still considered experimental in Pacific and is not officially supported.
