...
By default the objects a not verified again after the synchronization of an
object was successful. To enable that you can set ``rgw_sync_obj_etag_verify``
...
``rgw_sync_log_trim_interval`` is set to 20 minutes as default. If it isn't manually
...
to see all basic and advanced configuration options with their short description.
Expand the details of an option to reveal it's long description.
