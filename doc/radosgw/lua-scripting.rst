...
- If the value of ``key`` is not numeric, execution of the script will fail.
- If we try to increment or decrement with non-numeric values, execution of the script will fail.
