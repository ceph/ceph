...
- Policy: This will control who can access the topic other than owner of the topic.
  The policy passed needs to be json string similar to bucket policy.
  For example, one can send policy string as follows::
...
.. note::
  ...
  - The Attribute name passed will either be updated or created (if not exist) with AttributeValue passed.
  - Any un-supported attribute-name passed will result in error 400.
