...
and Salt.  However, those external configuration tools can be used to automate
operations not undertaken by cephadm itself. To learn more about these external
...
commands <https://www.redhat.com/en/blog/how-does-red-hat-support-day-2-operations>`_,
(maintenance operations)) to expand the cluster, adding hosts and
provisioning Ceph daemons and services. Management of this lifecycle can be
performed either via the Ceph command-line interface (CLI) or via the dashboard
(GUI).
