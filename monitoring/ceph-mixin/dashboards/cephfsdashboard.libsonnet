...
(import 'utils.libsonnet') {
  'cephfsdashboard.json':
    ...
    .addPanels([
      ...
      $.addRowSchema( collapse=false, showTitle=true, title='MDS', collapsed=true)
      .addPanels([
        $.timeSeriesPanel(
          title='Client Requests',
          datasource={ type: "prometheus", uid: "${datasource}" },
      ...
      .addTarget($.addTargetSchema(
        expr='increase(ceph_mds_reply_latency_sum[$interval]) * 1000 / increase(ceph_mds_reply_latency_count[$interval])',
        datasource={ type: "prometheus", uid: "${datasource}" },
        legendFormat='{{ ceph_daemon }}',
      )),
      ])
      + { gridPos: { x: 0, y: 9, w: 24, h: 1 } },
      $.addRowSchema( collapse=false, showTitle=true, title='Log', collapsed=true)
      .addPanels([
        $.timeSeriesPanel(
          title='Log Submit',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 8, x: 0, y: 11 },
          fillOpacity=10,
          pointSize=5,
          lineWidth=1,
          showPoints='never',
      ...
      $.timeSeriesPanel(
          title='Log Segments',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 8, x: 16, y: 11 },
          fillOpacity=10,
          pointSize=5,
          lineWidth=1,
          showPoints='never',
      ...
      $.timeSeriesPanel(
          ...
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 8, x: 16, y: 12 },
          fillOpacity=10,
          pointSize=5,
          lineWidth=1,
          showPoints='never',
      ...
      .addPanels([
        $.timeSeriesPanel(
          title='Pool Storage',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 14, x: 0, y: 13 },
          fillOpacity=40,
          pointSize=5,
          lineWidth=0,
          showPoints='never',
      ...
      $.timeSeriesPanel(
          ...
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 6, x: 14, y: 13 },
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
          showPoints='never',
      ...
      $.addGaugePanel(
        ...
        max=1,
        min=0,
        gridPosition={ x: 20, y: 13, w: 4, h: 7 },
        pluginVersion='9.4.7',
        maxDataPoints=100,
      ).addMappings([
        {
      ...
      $.timeSeriesPanel(
          title='IOPS',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 12, x: 0, y: 20 },
          axisLabel='IOPS',
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
      ...
      $.timeSeriesPanel(
          title='Throughput',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 12, x: 12, y: 20 },
          axisLabel='IOPS',
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
      ...
      .addPanels([
        $.timeSeriesPanel(
          title='Pool Storage',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 14, x: 0, y: 14 },
          fillOpacity=40,
          pointSize=5,
          lineWidth=0,
          showPoints='never',
      ...
      $.timeSeriesPanel(
          title='Objects in Pool',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 6, x: 14, y: 14 },
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
          showPoints='never',
      ...
      $.addGaugePanel(
        ...
        max=1,
        min=0,
        gridPosition={ x: 20, y: 14, w: 4, h: 7 },
        pluginVersion='9.4.7',
        maxDataPoints=100,
      ).addMappings([
        {
      ...
      $.timeSeriesPanel(
          title='IOPS',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 12, x: 0, y: 21 },
          axisLabel='IOPS',
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
      ...
      $.timeSeriesPanel(
          title='Throughput',
          datasource={ type: "prometheus", uid: "${datasource}" },
          gridPosition={ h: 7, w: 12, x: 12, y: 21 },
          axisLabel='IOPS',
          fillOpacity=10,
          pointSize=5,
          lineWidth=2,
