...
(import 'utils.libsonnet') {
  'cephfsdashboard.json':
    ...
    .addPanels([
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_mds_server_handle_client_request[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_mds_forward[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(increase(ceph_mds_reply_latency_sum[$__rate_interval])) / sum(increase(ceph_mds_reply_latency_count[$__rate_interval]))',
        interval='$__rate_interval',
        range=true,
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_server_handle_client_request[$__rate_interval])',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        range=true,
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_forward[$__rate_interval])',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_server_handle_slave_request[$__rate_interval])',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='increase(ceph_mds_reply_latency_sum[$__rate_interval]) / increase(ceph_mds_reply_latency_count[$__rate_interval])',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_log_evadd{}[$__rate_interval])',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
