  ...
  'cephfsdashboard.json':
    ...
    .addPanels([
      ...
      .addTarget($.addTargetSchema(
        expr='count(ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
      ...
      .addTarget($.addTargetSchema(
        expr='sum(ceph_pool_bytes_used{pool_id=~\"$mdatapool\"})',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_rd_bytes{pool_id=~\"$mdatapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addStatPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='sum(ceph_pool_bytes_used{pool_id=~\"$datapool\"})',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_rd_bytes{pool_id=~\"$datapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addStatPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_mds_server_handle_client_request[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(ceph_mds_sessions_session_count * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(ceph_mds_inodes * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_wr_bytes{pool_id=~\"$mdatapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addStatPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_wr_bytes{pool_id=~\"$datapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addGaugePanel(
      ...
      .addTarget($.addTargetSchema(
        expr='(1 - (sum(ceph_pool_max_avail{pool_id=~\"$mdatapool\"}) / (sum(ceph_pool_bytes_used{pool_id=~\"$mdatapool\"}) + sum(ceph_pool_max_avail{pool_id=~\"$mdatapool\"})))) * 100',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_rd{pool_id=~\"$mdatapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addGaugePanel(
      ...
      .addTarget($.addTargetSchema(
        expr='(1 - (sum(ceph_pool_max_avail{pool_id=~\"$datapool\"}) / (sum(ceph_pool_bytes_used{pool_id=~\"$datapool\"}) + sum(ceph_pool_max_avail{pool_id=~\"$datapool\"})))) * 100',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_rd{pool_id=~\"$datapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
      )),
      $.addStatPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_mds_forward[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(increase(ceph_mds_reply_latency_sum[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)) / sum(increase(ceph_mds_reply_latency_count[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        range=true,
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      ...
      .addTarget($.addTargetSchema(
        expr='sum(ceph_mds_caps * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        step=60,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_wr{pool_id=~\"$mdatapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        instant=true,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='sum(rate(ceph_pool_wr{pool_id=~\"$datapool\"}[$__rate_interval]))',
        interval='$__rate_interval',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        instant=true,
      )),
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_server_handle_client_request[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        range=true,
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_forward[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_server_handle_slave_request[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='ceph_mds_sessions_session_count * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='sum by (ceph_daemon) (increase(ceph_mds_reply_latency_sum[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)) / sum by (ceph_daemon) (increase(ceph_mds_reply_latency_count[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata))',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='rate(ceph_mds_log_evadd{}[$__rate_interval]) * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='ceph_mds_log_ev * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      $.timeSeriesPanel(
      ...
      .addTarget($.addTargetSchema(
        expr='ceph_mds_log_seg * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
        datasource={ type: 'prometheus', uid: '${datasource}' },
        legendFormat='{{ ceph_daemon }}',
      )),
      ...
      .addPanels([
        ...
        .addTarget($.addTargetSchema(
          expr='ceph_mds_mem_ino * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
          datasource={ type: 'prometheus', uid: '${datasource}' },
          legendFormat='{{ ceph_daemon }}',
        )),
        $.timeSeriesPanel(
        ...
        .addTarget($.addTargetSchema(
          expr='ceph_mds_exported_inodes * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
          datasource={ type: 'prometheus', uid: '${datasource}' },
          legendFormat='{{ ceph_daemon }}',
        )),
        $.timeSeriesPanel(
        ...
        .addTarget($.addTargetSchema(
          expr='ceph_mds_imported_inodes * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
          datasource={ type: 'prometheus', uid: '${datasource}' },
          legendFormat='{{ ceph_daemon }}',
        )),
        $.timeSeriesPanel(
        ...
        .addTarget($.addTargetSchema(
          expr='ceph_mds_mem_dn * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
          datasource={ type: 'prometheus', uid: '${datasource}' },
          legendFormat='{{ ceph_daemon }}',
        )),
        $.timeSeriesPanel(
        ...
        .addTarget($.addTargetSchema(
          expr='ceph_mds_caps * on(ceph_daemon) (ceph_fs_metadata{name=~\"$name\"} * on(fs_id) group_left(ceph_daemon) ceph_mds_metadata)',
          datasource={ type: 'prometheus', uid: '${datasource}' },
          legendFormat='{{ ceph_daemon }}',
        )),
      ])
      ...
      .addPanels([
        ...
        .addTargets(
          [
            $.addTargetSchema(
              expr='rate(ceph_pool_rd{pool_id=~"$mdatapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Read',
              step=60,
            ...
            $.addTargetSchema(
              expr='rate(ceph_pool_wr{pool_id=~"$mdatapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Write',
              step=60,
        ...
        .addTargets(
          [
            $.addTargetSchema(
              expr='rate(ceph_pool_rd_bytes{pool_id=~"$mdatapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
            ...
            $.addTargetSchema(
              expr='rate(ceph_pool_wr_bytes{pool_id=~"$mdatapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
      ...
      .addPanels([
        ...
        .addTargets(
          [
            $.addTargetSchema(
              expr='rate(ceph_pool_rd{pool_id=~"$datapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Read',
              step=60,
            ...
            $.addTargetSchema(
              expr='rate(ceph_pool_wr{pool_id=~"$datapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Write',
              step=60,
        ...
        .addTargets(
          [
            $.addTargetSchema(
              expr='rate(ceph_pool_rd_bytes{pool_id=~"$datapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Read Bytes',
              step=60,
            ...
            $.addTargetSchema(
              expr='rate(ceph_pool_wr_bytes{pool_id=~"$datapool"}[$__rate_interval])',
              datasource={ type: 'prometheus', uid: '${datasource}' },
              interval='$__rate_interval',
              legendFormat='Write Bytes',
              step=60,
