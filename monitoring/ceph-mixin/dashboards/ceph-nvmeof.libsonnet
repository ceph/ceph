...
(import 'utils.libsonnet') {
  'ceph-nvmeof.json': $.dashboardSchema(
    ...
    .addTarget(
      $.addTargetSchema(
        expr='count(ceph_nvmeof_metadata)',
        format='time_series',
        instant=true,
        legendFormat='Total',
        range=false,
    ...
    .addTarget(
      $.addTargetSchema(
        expr='count(ceph_nvmeof_metadata{status=~"1|2"})',
        format='time_series',
        instant=false,
    ...
    .addTarget(
      $.addTargetSchema(
        expr="count(ceph_nvmeof_metadata{status=~'0|-1|-2'})",
        format='time_series',
        instant=true,
        legendFormat='Down',
        range=false,
    ...
    .addTarget(
      $.addTargetSchema(
        expr="count(ceph_nvmeof_metadata{status=~'0'})",
        format='',
        instant=false,
    ...
    .addTarget(
      $.addTargetSchema(
        expr="count(ceph_nvmeof_metadata{status=~'-1'})",
        format='',
        instant=false,
        legendFormat='error',
        range=true,
    ...
    .addTarget(
      $.addTargetSchema(
        expr="count(ceph_nvmeof_metadata{status=~'-2'})",
        format='',
        instant=false,
