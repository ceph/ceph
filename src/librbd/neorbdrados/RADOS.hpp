...
#ifndef NEORBDRADOS_RADOS_HPP
#define NEORBDRADOS_RADOS_HPP
...
namespace std {
template<>
struct hash<neorbdrados::Object>;
template<>
struct hash<neorbdrados::IOContext>;
}
...
template<>
struct is_error_code_enum<::neorbdrados::errc> {
  static const bool value = true;
};

template<>
struct is_error_condition_enum<::neorbdrados::errc> {
...
template<>
struct hash<neorbdrados::Object> {
  size_t operator ()(const neorbdrados::Object& r) const;
};
template<>
struct hash<neorbdrados::IOContext> {
  size_t operator ()(const neorbdrados::IOContext& r) const;
};
} // namespace std

#endif // NEORBDRADOS_RADOS_HPP
