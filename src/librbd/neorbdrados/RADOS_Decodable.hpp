...
#ifndef NEORBDRADOS_RADOS_DECODABLE_HPP
#define NEORBDRADOS_RADOS_DECODABLE_HPP
...
namespace std {
template<>
struct hash<::neorbdrados::Entry> {
  std::size_t operator ()(::neorbdrados::Entry e) const {
    hash<std::string> h;
...
#if FMT_VERSION >= 90000
template <> struct fmt::formatter<neorbdrados::Entry> : ostream_formatter {};
#endif
