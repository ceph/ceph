...
private:
   ...
   *    |     \-------(group is not primary)  (group is primary)
   *    |                        |                   |
   *    |                        v                   |
   *    |                 FORCE_PROMOTE_GROUP        |
   *    |                        |                   |
  ...
  std::vector<bool> m_image_mirror_uuid_missing;
  ...
  void check_group_resync_flagged();
  void handle_check_group_resync_flagged(int r);
