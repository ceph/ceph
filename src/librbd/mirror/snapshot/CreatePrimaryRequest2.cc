...
template <typename I>
void CreatePrimaryRequest2<I>::create_snapshot() {

  auto ctx = create_context_callback<
    CreatePrimaryRequest2<I>,
    &CreatePrimaryRequest2<I>::handle_create_snapshot>(this);
...
template <typename I>
void CreatePrimaryRequest2<I>::handle_create_snapshot(int r) {
  ldout(m_cct, 15) << "r=" << r << dendl;
...
template <typename I>
void CreatePrimaryRequest2<I>::refresh_image() {
  ...
  auto ctx = create_context_callback<
    CreatePrimaryRequest2<I>,
    &CreatePrimaryRequest2<I>::handle_refresh_image>(this);
...
template <typename I>
void CreatePrimaryRequest2<I>::handle_refresh_image(int r) {
  ldout(m_cct, 15) << "r=" << r << dendl;
  ...
  if (!m_group_snap_id.empty()) {
    for (size_t i = 0; i < m_image_ctxs.size(); i++) {
      ...
      ldout(m_cct, 15) << "snap_id=" << snap_id << dendl;
    }
  }
