...
public:
  ...
  static int diff_iterate_from_parent(ImageCtxT *ictx,
                          uint64_t off, uint64_t len,
		          int (*cb)(uint64_t, size_t, int, void *),
		          void *arg);

  static int diff_iterate_base(ImageCtxT *ictx,
			  const cls::rbd::SnapshotNamespace& from_snap_namespace,
			  const char *fromsnapname,
                          uint64_t off, uint64_t len, bool include_parent,
                          bool whole_object, bool from_parent,
		          int (*cb)(uint64_t, size_t, int, void *),
		          void *arg);
...
private:
  ...
  DiffIterate(ImageCtxT &image_ctx, 
	      ...
	      bool include_parent, bool whole_object, bool from_parent,
    ...
    : m_image_ctx(image_ctx), m_from_snap_namespace(from_snap_namespace),
      ...
      m_whole_object(whole_object), m_from_parent(from_parent),
