...
public:
  ...
  inline int operator()(
    ...
    mirror_snap->complete = false;
    if(group_snap_state == cls::rbd::GROUP_SNAPSHOT_STATE_CREATED &&
       (snap_namespace.complete == cls::rbd::MIRROR_GROUP_SNAPSHOT_COMPLETE ||
        snap_namespace.complete == cls::rbd::MIRROR_GROUP_SNAPSHOT_COMPLETE_IF_CREATED)) {
