...
struct Mirror {
  ...
  typedef std::map<std::string, mirror_group_status_t> IdToMirrorGroupStatus;
  ...
  static int image_enable(ImageCtxT *ictx, int64_t group_pool_id,
  ...
  static void image_promote(ImageCtxT *ictx, int64_t group_pool_id,
                            const std::string &group_id,
  ...
  static void image_demote(ImageCtxT *ictx, int64_t group_pool_id,
                           const std::string &group_id,
  ...
  static int group_create_snapshot(IoCtx& group_ioctx, const char *group_name,
