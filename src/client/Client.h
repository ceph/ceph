...
protected:
  ...
  Inode* get_any_quota_root(Inode *in, const UserPerm& perms);
...
private:
  ...
  bool _vxattrcb_snap_btime_exists(Inode *in, const char *name);
  size_t _vxattrcb_snap_btime(Inode *in, char *val, size_t size, const char *name);
