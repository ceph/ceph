...
const struct sm_state_t filelock[LOCK_MAX] = {
    ...
    [LOCK_EXCL]      = { 0,         true,  LOCK_LOCK, XCL,  0,   XCL, XCL, 0,   0,   0,   0,CEPH_CAP_GSHARED|CEPH_CAP_GEXCL|CEPH_CAP_GCACHE|CEPH_CAP_GRD|CEPH_CAP_GWR|CEPH_CAP_GBUFFER,0,0 },
    ...
    [LOCK_EXCL_XSYN] = { LOCK_XSYN, false, LOCK_LOCK, XCL,  0,   XCL, 0,   0,   0,   0,   0,CEPH_CAP_GCACHE|CEPH_CAP_GBUFFER,0,0 },
