...
void CInode::pop_and_dirty_projected_inode(LogSegmentRef ls, const MutationRef& mut)
{
...
void CInode::_mark_dirty(LogSegmentRef ls)
{
...
void CInode::mark_dirty(LogSegmentRef ls) {
...
void CInode::mark_dirty_parent(LogSegmentRef ls, bool dirty_pool)
{
