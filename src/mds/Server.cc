...
void Server::open_logger()
{
  ...
  plb.add_inc(l_mdss_hcreq,"hcreq"); // handle client req
  plb.add_inc(l_mdss_hsreq, "hsreq"); // slave
  plb.add_inc(l_mdss_hcsess, "hcsess");    // client session
  plb.add_inc(l_mdss_dcreq, "dcreq"); // dispatch client req
  plb.add_inc(l_mdss_dsreq, "dsreq"); // slave
