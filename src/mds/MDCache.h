...
private:
  ...
  int load_referent_inodes(CInode *in, MDSContextFactory& cf, bool ignore_error=false);
  ...
  void open_remote_referent(inodeno_t ino, MDSContext *fin, bool want_xlocked=false, bool ignore_error=false);
