...
public:
  ...
  Capability(CInode *i=nullptr, ceph::ref_t<class Session> = nullptr, uint64_t id=0);
  ...
  ceph::ref_t<class Session> get_session() const { return session; }
...
private:
  ...
  CInode *inode;
  ceph::ref_t<class Session> session;
