...
#ifndef RBD_MIRROR_GROUP_REPLAYER_GROUP_STATE_UPDATE_REQUEST_H
#define RBD_MIRROR_GROUP_REPLAYER_GROUP_STATE_UPDATE_REQUEST_H
...
#endif // RBD_MIRROR_GROUP_REPLAYER_GROUP_STATE_UPDATE_REQUEST_H
