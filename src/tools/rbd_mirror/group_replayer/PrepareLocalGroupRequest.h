...
public:
  ...
  PrepareLocalGroupRequest(
    ...
    : m_io_ctx(io_ctx), m_global_group_id(global_group_id),
      m_local_group_id(local_group_id), m_local_group_name(local_group_name),
      m_mirror_group(mirror_group), m_state_builder(state_builder),
