...
private:
  ...
  size_t m_outstanding_validations;
  ...
  void mirror_snapshot_complete(std::unique_lock<ceph::mutex>* locker,
  ...
  void regular_snapshot_complete(std::unique_lock<ceph::mutex>* locker,
