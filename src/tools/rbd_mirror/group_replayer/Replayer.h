 ...
 *          |          |     true             v                                                    |                                 |
 *          |          + <------------ IS_RENAME_REQUESTED                                         |                                 |
 *          |                                 |                snapshots pruning in progress       |                                 |
 *          |                                 v                     r == -EAGAIN                   |                                 |
 *          |                     PRUNE_USER_GROUP_SNAPSHOTS -------------------------------------->                                 |
 *          |                                 |                                                    |                                 |
 *          |                                 |    one or more user group snapshots pruned         |                                 |
 *          |                                 v         m_refresh_snaps == true                   ╭─╮                                |
 *          |                                 +------------------------------------------------->-╯|╰->----------------------------> +
 *          |                                 |                                                    |                                 ^
 *          |                                 v                                                    |                                 |
 *          |                     CREATE_USER_GROUP_SNAPSHOTS  (skip if not required)              |                                 |
 *          |                                 |                                                    |                                 |
 *          |                                 v                                                    |                                 |
 *          |                      CREATE_USER_GROUP_SNAPSHOT  (skip if not required)              |                                 |
 *          |                                 |                                                    |                                 |
 *          |                                 v                                                    |                                 |
 *          |                      CREATE_MIRROR_GROUP_SNAPSHOT                                    |                                 |
 *          |                                 |                                                    |                                 |
 *          |                                 v                                                    |                                 |
 *          |                        GET_MIRROR_PEER_LIST (skip if not required)                   |                                 |
 *          |                                 |                                                    |                                 |
 *          |                                 v                                                    |                                 |
 ...
 */
  ...
  void scan_local_group_snapshots(std::unique_lock<ceph::mutex>* locker);
  void scan_remote_group_snapshots(std::unique_lock<ceph::mutex>* locker);
