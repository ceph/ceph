...
std::list<NotifyMessage> NotifyMessage::generate_test_instances() {
  ...
  o.push_back(NotifyMessage(GroupAcquirePayload()));
  o.push_back(NotifyMessage(GroupAcquirePayload(1, "gid")));

  o.push_back(NotifyMessage(GroupReleasePayload()));
  o.push_back(NotifyMessage(GroupReleasePayload(1, "gid")));

  o.push_back(NotifyMessage(PeerGroupRemovedPayload()));
  o.push_back(NotifyMessage(PeerGroupRemovedPayload(1, "gid", "uuid")));
  return o;
}
