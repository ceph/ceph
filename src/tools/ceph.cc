...
static void usage()
{
  ...
  cout << "ceph mds stat\n";
  cout << "ceph mds tell <mds-id> injectargs --<switch> <value> [--<switch> <value>...]\n";
  cout << "\n";
  cout << "** MONITOR (MON) COMMANDS **\n";
  cout << "ceph mon add <name> <ip>[:<port>]\n";
  cout << "ceph mon delete <monitor name>\n";
  cout << "ceph mon stat\n";
  cout << "\n";
  cout << "** OBJECT STORAGE DEVICE (OSD) COMMANDS **\n";
  cout << "ceph osd dump [ --format <format> ]\n";
  cout << "ceph osd tree\n";
  cout << "ceph osd set <noout|nodown>\n";
  cout << "ceph osd unset <noout|nodown>\n;
  cout << "ceph osd tell <osd-id> -- injectargs --<switch> <value> [--<switch> <value>...]\n";
  cout << "ceph osd getcrushmap -o <file>\n";
  cout << "ceph osd getmap -o <file>\n";
  cout << "ceph osd crush set <osd-id> <name> <weight> [<loc1> [<loc2> ...]]\n";
  cout << "ceph osd crush move <osd-id> <loc1> [<loc2> ...]\n";
  cout << "ceph osd crush reweight <name> <weight>\n";
  cout << "ceph osd cluster_snap <name\n";
  cout << "ceph osd lost [--yes-i-really-mean-it]\n";
  cout << "ceph osd create [<osd-id>]\n";
  cout << "ceph osd rm <osd-id> [<osd-id>...]\n";
  cout << "ceph osd getmaxosd\n";
  ...
  cout << "ceph osd pool create <pool> [<pg_num> [<pg_num>..]]\n";
