...
"   bench <seconds> write|seq|rand [-t concurrent_operations] [-b op_size] [-O object_size] [--no-cleanup] [--run-name run_name] [--no-hints] [--reuse-bench]\n"
"                                    default is 16 concurrent IOs and 4 MB object_size\n"
"                                    default is to clean up after write benchmark\n"
"                                    default run-name is 'benchmark_last_metadata'\n"
"                                    seq and rand benchmarks are read-only tests\n"
...
"   -b op_size\n"
"        set the block size in bytes for put/get ops and for write benchmarking\n"
"   -O object_size\n"
"        set the object size in bytes for put/get ops and for write benchmarking\n"
"   --max-objects\n"
