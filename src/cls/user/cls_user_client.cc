...
class ClsAccountListCtx : public librados::ObjectOperationCompletion {
  std::vector<cls_user_account_resource>* entries;
  bool* truncated;
  std::string* next_marker;
  int* pret;
public:
  ClsAccountListCtx(std::vector<cls_user_account_resource>* entries,
                                    ...
                                    int* pret)
{
  ...
  op.exec("user", "account_resource_list", inbl,
          new ClsAccountListCtx(&entries, truncated, next_marker, pret));
}
