...
typedef boost::variant<UserGroupSnapshotNamespace,
                       MirrorGroupSnapshotNamespace,
...
struct GroupSnapshotNamespace : public GroupSnapshotNamespaceVariant {
  ...
  template <typename T>
  GroupSnapshotNamespace(T&& t)
    : GroupSnapshotNamespaceVariant(std::forward<T>(t)) {
  }
  ...
  inline bool operator==(const GroupSnapshotNamespaceVariant& sn) const {
    return static_cast<const GroupSnapshotNamespaceVariant&>(*this) == sn;
  }
  inline bool operator<(const GroupSnapshotNamespaceVariant& sn) const {
    return static_cast<const GroupSnapshotNamespaceVariant&>(*this) < sn;
  }
