...
struct MirrorGroup {
  ...
  static std::list<MirrorGroup> generate_test_instances();
...
struct MirrorGroupImageSpec {
  ...
  static std::list<MirrorGroupImageSpec> generate_test_instances();
...
struct MirrorGroupSiteStatus {
  ...
  static std::list<MirrorGroupSiteStatus> generate_test_instances();
};
...
struct MirrorGroupSiteStatusOnDisk : cls::rbd::MirrorGroupSiteStatus {
  ...
  static std::list<MirrorGroupSiteStatusOnDisk> generate_test_instances();
};
...
struct MirrorGroupStatus {
  ...
  static std::list<MirrorGroupStatus> generate_test_instances();
};
...
struct GroupSnapshotNamespace : public GroupSnapshotNamespaceVariant {
  ...
  static std::list<GroupSnapshotNamespace> generate_test_instances();
};
