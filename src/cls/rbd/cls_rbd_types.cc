...
std::list<MirrorImage> MirrorImage::generate_test_instances() {
  ...
  o.push_back(MirrorImage(MIRROR_IMAGE_MODE_SNAPSHOT, "uuid-abc", {"g1", 1},
...
std::list<MirrorGroup> MirrorGroup::generate_test_instances() {
  std::list<MirrorGroup> o;
  o.push_back(MirrorGroup());
  o.push_back(MirrorGroup("uuid-123", MIRROR_IMAGE_MODE_SNAPSHOT,
...
std::list<MirrorGroupImageSpec> MirrorGroupImageSpec::generate_test_instances() {
  std::list<MirrorGroupImageSpec> o;
  o.push_back(MirrorGroupImageSpec());
  o.push_back(MirrorGroupImageSpec(1, "global_id"));
  return o;
}
...
std::list<MirrorGroupSiteStatus> MirrorGroupSiteStatus::generate_test_instances() {
  std::list<MirrorGroupSiteStatus> o;
  o.push_back(MirrorGroupSiteStatus());
  o.push_back(MirrorGroupSiteStatus("", MIRROR_GROUP_STATUS_STATE_REPLAYING,
                                    "", {}));
  o.push_back(MirrorGroupSiteStatus("", MIRROR_GROUP_STATUS_STATE_ERROR,
                                    "error", {{{}, {}}}));
  o.push_back(MirrorGroupSiteStatus("2fb68ca9-1ba0-43b3-8cdf-8c5a9db71e65",
...
std::list<MirrorGroupSiteStatusOnDisk> MirrorGroupSiteStatusOnDisk::generate_test_instances() {
  std::list<MirrorGroupSiteStatusOnDisk> o;
  o.push_back(MirrorGroupSiteStatusOnDisk());
  o.push_back(MirrorGroupSiteStatusOnDisk(
...
std::list<MirrorGroupStatus> MirrorGroupStatus::generate_test_instances() {
  std::list<MirrorGroupStatus> o;
  o.push_back(MirrorGroupStatus());
  o.push_back(MirrorGroupStatus({{"", MIRROR_GROUP_STATUS_STATE_ERROR, "", {}}}));
  o.push_back(MirrorGroupStatus({{"", MIRROR_GROUP_STATUS_STATE_STOPPED, "", {}},
...
std::list<SnapshotNamespace> SnapshotNamespace::generate_test_instances() {
  ...
  o.push_back(SnapshotNamespace(GroupImageSnapshotNamespace(0, "10152ae8944a",
                                                            "2118643c9732")));
  o.push_back(SnapshotNamespace(GroupImageSnapshotNamespace(5, "1018643c9869",
                                                            "33352be8933c")));
...
std::list<GroupSnapshotNamespace> GroupSnapshotNamespace::generate_test_instances() {
  std::list<GroupSnapshotNamespace> o;
  o.push_back(GroupSnapshotNamespace(UserGroupSnapshotNamespace()));
  o.push_back(GroupSnapshotNamespace(MirrorGroupSnapshotNamespace(
...
std::list<GroupSnapshot> GroupSnapshot::generate_test_instances() {
  ...
  o.push_back(GroupSnapshot("10152ae8944a", UserGroupSnapshotNamespace{},
                            "groupsnapshot1",
