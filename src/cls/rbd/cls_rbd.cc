...
CLS_INIT(rbd)
{
 ...
 /* methods for the old format */
  ...
  cls.register_cxx_method(method::mirror_group_remove, mirror_group_remove, &h_mirror_group_remove);
  cls.register_cxx_method(method::mirror_group_status_set, mirror_group_status_set, &h_mirror_group_status_set);
  cls.register_cxx_method(method::mirror_group_status_remove, mirror_group_status_remove, &h_mirror_group_status_remove);
  cls.register_cxx_method(method::mirror_group_status_get, mirror_group_status_get, &h_mirror_group_status_get);
  cls.register_cxx_method(method::mirror_group_status_list, mirror_group_status_list, &h_mirror_group_status_list);
  cls.register_cxx_method(method::mirror_group_status_get_summary, mirror_group_status_get_summary, &h_mirror_group_status_get_summary);
  cls.register_cxx_method(method::mirror_group_status_remove_down, mirror_group_status_remove_down, &h_mirror_group_status_remove_down);
  cls.register_cxx_method(method::mirror_group_instance_get, mirror_group_instance_get, &h_mirror_group_instance_get);
  cls.register_cxx_method(method::mirror_group_instance_list, mirror_group_instance_list, &h_mirror_group_instance_list);
  ...
  cls.register_cxx_method(method::group_snap_unlink, group_snap_unlink, &h_group_snap_unlink);
