...
constexpr auto mirror_group_resync_get = ClsMethod<RdTag, ClassId>("mirror_group_resync_get");
constexpr auto mirror_group_resync_set = ClsMethod<RdWrTag, ClassId>("mirror_group_resync_set");
constexpr auto mirror_group_resync_remove = ClsMethod<RdWrTag, ClassId>("mirror_group_resync_remove");
