...
#define RGW_BUCKET_STATS_SUMMARY_SET "bucket_stats_summary_set"
#define RGW_BUCKET_STATS_SUMMARY_APPLY_DELTA "bucket_stats_summary_apply_delta"
#define RGW_BUCKET_STATS_SUMMARY_SET_GENERATION "bucket_stats_summary_set_generation"
