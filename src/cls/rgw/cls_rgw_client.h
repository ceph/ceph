...
void cls_rgw_bucket_prepare_op(librados::ObjectWriteOperation& o, RGWModifyOp op, const std::string& tag,
                               ...
                               uint16_t bilog_op, const rgw_zone_set& zones_trace, const std::string& log_zonegroup);
...
void cls_rgw_bucket_link_olh(librados::ObjectWriteOperation& op,
                            ...
                            uint64_t olh_epoch, ceph::real_time unmod_since, bool high_precision_time, bool log_op, const rgw_zone_set& zones_trace, const std::string& log_zonegroup);
void cls_rgw_bucket_unlink_instance(librados::ObjectWriteOperation& op,
                                   const cls_rgw_obj_key& key, const std::string& op_tag,
                                   const std::string& olh_tag, uint64_t olh_epoch, bool log_op, uint16_t bilog_flags, const rgw_zone_set& zones_trace, const std::string& log_zonegroup);
...
int cls_rgw_bucket_unlink_instance(librados::IoCtx& io_ctx, const std::string& oid,
                                   ...
                                   uint16_t bilog_flags, const rgw_zone_set& zones_trace, const std::string& log_zonegroup);
