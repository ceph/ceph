...
class ScrubBackend {
 ...
 private:
  ...
  std::string extract_crcs_from_map(shard_id_map<bufferlist> map);
  std::string extract_crc_from_bufferlist(bufferlist crc_buffer);
  inline char retrieve_byte(uint32_t value, uint32_t index) {
