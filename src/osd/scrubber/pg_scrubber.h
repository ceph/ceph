...
class PgScrubber : public ScrubPgIF,
 ...
 protected:
  ...
  /**
   * caching a text description of the operational flags (m_flags),
   * as this text appears as part of the PG concise description
   * in the logs.
   */
  std::string m_flags_text;

  void update_cur_scrub_flags_text();

  std::string_view get_cur_scrub_flags_text() const;
