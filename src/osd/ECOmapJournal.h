...
class ECOmapValue {
 public:
  ...
  ECOmapValue(const eversion_t version, const std::optional<ceph::buffer::list> &value) : version(version), value(value) {}
...
class RemovedRanges {
 public:
  ...
  explicit RemovedRanges(const eversion_t version) : version(version) {}
  RemovedRanges(const eversion_t version, std::list<std::pair<std::string, std::optional<std::string>>> ranges)
