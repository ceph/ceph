  ...
  while (1) {
    ...
    case RecoveryOp::IDLE: {
      ...
      if (op.obc) {
        ...
        // 'remaining' is not guaranteed to be stripe_width aligned (unlike
        // get_recovery_chunk_size()), but do_read_op() requires read
        // lengths to be stripe_width aligned.
        amount = round_up_to(amount, sinfo.get_stripe_width());
      }
