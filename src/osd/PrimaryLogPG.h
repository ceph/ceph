...
public:
  ...
  bool _do_osd_op_pre(OpContext *ctx, OSDOp& osd_op, int& result);
  void _do_osd_op_post(OpContext *ctx, OSDOp& osd_op, int& result);
  OpFinisher* _get_finisher(OpContext *ctx);
  int do_osd_ops(OpContext *ctx, vector<OSDOp>& ops);

  // do_osd_op sub functions
  int _ceph_osd_op_cmpext(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_sync_read(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_read(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_checksum(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_mapext(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_sparse_read(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_call(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_stat(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_isdirty(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_undirty(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cache_try_flush(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cache_flush(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cache_evict(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_getxattr(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_getxattrs(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cmpxattr(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_assert_ver(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_list_watchers(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_list_snaps(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_notify(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_notify_ack(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_setallochint(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_write(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_writefull(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_writesame(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_rollback(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_zero(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_create(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_trimtrunc(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_truncate(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_delete(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_watch(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cache_pin(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_cache_unpin(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_set_redirect(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_set_chunk(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tier_promote(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tier_flush(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_unset_manifest(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_setxattr(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_rmxattr(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_append(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_startsync(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tmapget(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tmapput(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tmapup(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_tmap2omap(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapgetkeys(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapgetvals(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapgetheader(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapgetvalsbykeys(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omap_cmp(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapsetvals(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapsetheader(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omapclear(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omaprmkeys(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_omaprmkeyrange(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_copy_get(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_copy_from(OpContext *ctx, OSDOp& osd_op);
  int _ceph_osd_op_default(OpContext *ctx, OSDOp& osd_op);
