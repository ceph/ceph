...
bool OpRequest::need_skip_full_check() {
   return check_rmw(CEPH_OSD_RMW_FLAG_SKIP_FULL_CHECK);
}
...
void OpRequest::set_skip_full_check() { set_rmw_flags(CEPH_OSD_RMW_FLAG_SKIP_FULL_CHECK); }
