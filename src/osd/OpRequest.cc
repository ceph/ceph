...
bool OpRequest::force_rwordered() {
  return check_rmw(CEPH_OSD_RMW_FLAG_FORCE_RWORDERED);
}
...
void OpRequest::set_force_rwordered() {
  set_rmw_flags(CEPH_OSD_RMW_FLAG_FORCE_RWORDERED);
}
