...
private:
  ...
  /// effective seek term: the configured value on rotational media,
  /// 0 on flash, which pays no positioning cost
  ...
  struct Stream {
    ...
    /// scaled bytes served this round; may overrun next_budget by
    /// one oversized item
