...
enum {
  ...
  l_osd_op_enqueue_lat,
  l_osd_op_shard_queued_lat,
  l_osd_op_r,
  l_osd_op_r_outb,
  l_osd_op_r_lat,
  l_osd_op_r_process_lat,
  l_osd_op_r_prepare_lat,
  l_osd_op_r_enqueue_lat,
  l_osd_op_r_shard_queued_lat,
  l_osd_op_w,
  l_osd_op_w_inb,
  l_osd_op_w_rlat,
  l_osd_op_w_lat,
  ...
  l_osd_op_w_enqueue_lat,
  l_osd_op_w_shard_queued_lat,
  l_osd_op_rw,
  l_osd_op_rw_inb,
  l_osd_op_rw_outb,
  l_osd_op_rw_rlat,
  ...
  l_osd_op_rw_enqueue_lat,
  l_osd_op_rw_shard_queued_lat,
