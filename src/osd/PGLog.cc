    ...
    pg_shard_t from) const
{
    ...
    */
    ...
    //����������pg info������û�и���missing,��activate�в����˷�divergent��missing��Ϣ
    //2016-5-7,�����Ͳ��ø���missing,�����Ǵ���replica��log��Ҫ����peer missing
    //��һ����Ҫ������peer��last_complete
    ...
    LogEntryHandler *rollbacker)
{
    ...
    {
        /// Case 1)
        //��������˼���������и��µ�log,��ô��Щlog��Ȼ����auth log�Ľڵ㣬
        //��log��versionӦ�ñ�last_divergent_update��
                      ...
                      bool &dirty_info, bool &dirty_big_info)
{
    ...
    if (olog.head > log.head)
    {
        ...
        //�����汾���ַ�֧�ˣ���ôlower_bound�����Ǹ����һ�һֱ�ķֲ���
        ...
        for (list<pg_log_entry_t>::iterator p = from; p != to; ++p)
        {
            ...
            log.index(ne);
            //���� > last_backfill,��ô���滹��ɨ�赽�����üӵ�missing
        ...
        while (!log.empty())
        {
             ...
             */
            //ʹ�� oe.versionҲ�ܱ�����������,���ǳ���our log: 122'10
            //new log : 100'10������������lower_bound������������
        ...
        //�������㶼�и�ǰ��:olog.head.epoch >= log.head.epoch
        // splice
