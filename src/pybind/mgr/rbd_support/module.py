...
class Module(MgrModule):
    ...
    @RBDSupportCLICommand.Write('rbd mirror group snapshot schedule add')
    @with_latest_osdmap
    ...
    @RBDSupportCLICommand.Write('rbd mirror group snapshot schedule remove')
    @with_latest_osdmap
    ...
    @RBDSupportCLICommand.Read('rbd mirror group snapshot schedule list')
    @with_latest_osdmap
    ...
    @RBDSupportCLICommand.Read('rbd mirror group snapshot schedule status')
    @with_latest_osdmap
