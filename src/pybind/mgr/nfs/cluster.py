...
def write_cluster_qos_obj(
    ...
    clust_qos_msg_interval: Optional[str] = None,
...
class NFSCluster:
            ...
            if qos_obj:
                ...
                if status:
                    ...
                    if qos_obj.clust_qos_msg_interval:
                        clust_qos_msg_interval = f'{qos_obj.clust_qos_msg_interval}ms'
    ...
    def global_cluster_qos_action(
        ...
        cluster_id: str,
        action: str,
        msg_interval: Optional[str] = None
    ) -> None:
        try:
