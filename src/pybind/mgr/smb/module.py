...
class Module(orchestrator.OrchestratorClientMixin, MgrModule, CLICommandBase=cli.SMBCommandBase):
    ...
    @CLICommand('share create', perm='rw')
    def share_create(
        self,
        cluster_id: str,
        share_id: str,
