...
def subvolume_purge(fs_client, volspec, volname, trashcan, subvolume_trash_entry, should_cancel, purge_queue):
        ...
        with open_volume(fs_client, volname) as fs_handle:
            with open_group(fs_handle, volspec, groupname) as group:
                with open_subvol(fs_client.mgr, fs_handle, volspec, group, subvolname, SubvolumeOpType.REMOVE) as subvolume:
                    ...
                    trashcan.purge(subvolume.base_path, should_cancel, purge_queue)
    except VolumeException as ve:
                ...
                try:
                    ...
                    if stat.S_ISLNK(stx['mode']):
                        ...
                        try:
                            ...
                            if delink:
                                subvolume_purge(fs_client, volspec, volname, trashcan, tgt, should_cancel, purge_queue)
