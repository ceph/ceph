...
class VolumeClient(CephfsClient["Module"]):
    ...
    def _create_purge_status_report(self, volname):
        ...
        of data purged.
        '''
        subvols_left = self.purge_progress_bar.subvols_left
        files_left = self.purge_progress_bar.files_left
        size_left = self.purge_progress_bar.size_left
        ...
        total_subvols = self.purge_progress_bar.total_subvols
        total_files = self.purge_progress_bar.total_files
        total_size = self.purge_progress_bar.total_size
