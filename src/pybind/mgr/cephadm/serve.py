    ...
    def _apply_all_services(self) -> bool:
        ...
        for spec in specs:
            try:
                ...
                self.mgr.apply_spec_fails.append(msg)
                self.mgr.set_health_warning('CEPHADM_APPLY_SPEC_FAIL', f'Failed to apply {len(self.mgr.apply_spec_fails)} service(s)', len(self.mgr.apply_spec_fails), self.mgr.apply_spec_fails)
