...
class Migrations:
    ...
    migrate_nvmeof_spdk_alloc_legacy_policy = "bdevs_per_cluster"
    migrate_nvmeof_spdk_alloc_new_policy = "cluster_connections"
    migrate_nvmeof_spdk_alloc_default_value = 32
    def migrate_nvmeof_spec(
        ...
        new_spec["spec"].pop(migrate_nvmeof_spdk_alloc_legacy_policy)
        new_spec["spec"][migrate_nvmeof_spdk_alloc_new_policy] = migrate_nvmeof_spdk_alloc_default_value
    ...
    def nvmeof_spec_needs_migration(self, spec: Dict[Any, Any]) -> bool:
        ...
        return (
            bool(spec)
            and migrate_nvmeof_spdk_alloc_legacy_policy in spec["spec"]
            and spec["spec"][migrate_nvmeof_spdk_alloc_legacy_policy] == migrate_nvmeof_spdk_alloc_default_value
        )
