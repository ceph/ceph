...
from cephadm.services.cephadmservice import CephadmDaemonDeploySpec, _get_dashboard_server_addr
...
class TestMonitoring:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # IPv6 loopback — used as-is from mgr_map
            ...
            # FQDN already in mgr_map — passed through unchanged
            (
