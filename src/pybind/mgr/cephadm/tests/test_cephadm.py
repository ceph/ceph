...
class TestCephadm(object):
    ...
    def test_valid_url(self, cephadm_module):
        ...
        test_cases = [
            ...
            ("192.168.100.100", "prometheus multi-cluster targets updated"),
        ]
    ...
    def test_invalid_url(self, cephadm_module):
        ...
        test_cases = [
            ("http://example.com:9090", "Invalid service endpoint 'http://example.com:9090'. It should only be in the format host_ip:port."),
            ("192.168.100.100:99999", "Invalid service endpoint. Port out of range 0-65535")
        ]
        with with_host(cephadm_module, 'test'):
            with with_service(cephadm_module, ServiceSpec(service_type='prometheus'), CephadmOrchestrator.apply_prometheus, 'test'):
                for url, expected_output in test_cases:
