...
class TestCertMgr(object):
    ...
    def test_tlsobject_store_cert_ls(self, _set_store, cephadm_module: CephadmOrchestrator):
        ...
        def compare_certls_dicts(expected_ls):
            actual_ls = cephadm_module.cert_mgr.cert_ls(include_datails=True, include_cephadm_signed=True)
...
class TestTLSObjectStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.store = TLSObjectStore(self.mgr, MockTLSObject, known_entities, self.is_cephadm_signed_entity)
