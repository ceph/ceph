...
from ceph.deployment.service_spec import IscsiServiceSpec, MonitoringSpec, \
    ServiceSpec, RGWSpec
...
class TestMonitoring:
    ...
    def test_grafana_initial_admin_pw(self, cephadm_module: CephadmOrchestrator):
        with with_host(cephadm_module, 'test'):
            with with_service(cephadm_module, MonitoringSpec('grafana', other_properties=dict(initial_admin_password='secure'))):
