...
class GrafanaService(CephadmService):
    ...
    def generate_config(self, daemon_spec: CephadmDaemonDeploySpec) -> Tuple[Dict[str, Any], List[str]]:
        ...
        prometheus_dashboard_yml = self.mgr.template.render(
            'services/grafana/prometheus_dashboard.yml.j2'
        )
        ...
        config_file = {
            'files': {
                ...
                'provisioning/dashboards/prometheus_dashboard.yml': prometheus_dashboard_yml,
