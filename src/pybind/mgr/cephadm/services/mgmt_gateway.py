...
class MgmtGatewayService(CephadmService):
    ...
    def generate_config(self, daemon_spec: CephadmDaemonDeploySpec) -> Tuple[Dict[str, Any], List[str]]:
        ...
        tls_certs = self.get_self_signed_certificates_with_label(svc_spec, daemon_spec, INTERNAL_CERT_LABEL)
        daemon_config = {
            "files": {
                ...
                "nginx_internal.crt": tls_certs.cert,
                "nginx_internal.key": tls_certs.key,
                "ca.crt": tls_certs.ca_cert
            }
        }
