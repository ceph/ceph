...
class TLSObjectStore():
    ...
    def determine_tlsobject_target(self, obj_name: str, target: Optional[str]) -> Tuple[Optional[str], Optional[str]]:
    ...
    def get_tlsobject_scope_and_target(self, obj_name: str, service_name: Optional[str] = None, host: Optional[str] = None) -> Tuple[TLSObjectScope, Optional[Any]]:
        if obj_name in self.service_scoped_objects:
    ...
    def get_tlsobject(self, obj_name: str, service_name: Optional[str] = None, host: Optional[str] = None) -> Optional[TLSObjectProtocol]:
    ...
    def save_tlsobject(self, obj_name: str, tlsobject: str, service_name: Optional[str] = None, host: Optional[str] = None, user_made: bool = False, editable: bool = False) -> None:
        self._validate_tlsobject_name(obj_name, service_name, host)
