            ...
            if d.daemon_type == 'promtail':
                ...
                if msg.startswith('Removed'):
                    ...
                    if service_msg.startswith('Removed'):
                        self._deploy_alloy_if_needed()
                    continue  # Skip further upgrade for promtail

            # --- Normal upgrade process for non-promtail daemons ---
    ...
    def _deploy_alloy_if_needed(self) -> None:
        ...
        if not remaining_promtails:
            try:
                ...
                logger.info('All promtail services and daemons removed. Deploying alloy...')
