...
class CephadmOrchestrator(orchestrator.Orchestrator, MgrModule,
    ...
    MODULE_OPTIONS = [
        ...
        Option(
            ...
            type='str',
            default='',
            desc='Comma separated list of mon flags to set when --set-mon-flags '
...
> ssh -F ssh_config -i ~/cephadm_private_key {self.ssh_user}@{addr}'''
    ...
    def upgrade_start(self, image: str, version: str, daemon_types: Optional[List[str]] = None, host_placement: Optional[str] = None,
                      services: Optional[List[str]] = None, limit: Optional[int] = None, no_mon_flags: bool = False) -> str:
        if self.inventory.get_host_with_state("maintenance"):
        ...
        return self.upgrade.upgrade_start(image, version, daemon_types, hosts, services, limit, no_mon_flags)
