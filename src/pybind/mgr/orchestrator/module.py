...
class OrchestratorCli(OrchestratorClientMixin,
                      MgrModule,
                      CLICommandBase=OrchestratorCLICommandBase):
    MODULE_OPTIONS = [
        Option(
            'orchestrator',
            type='str',
    ...
    @CLIWriteCommand(prefix='device light')
    ...
    @CLIWriteCommand('orch hardware status')
    ...
    @CLIWriteCommand('orch hardware light')
    ...
    @CLIWriteCommand('orch hardware powercycle')
    ...
    @CLIWriteCommand('orch hardware shutdown')
    ...
    @CLIWriteCommand('orch host drain')
    ...
    @CLIWriteCommand('orch host drain stop')
    ...
    @CLIWriteCommand('orch host set-addr')
    ...
    @CLIWriteCommand('orch host label add')
    ...
    @CLIWriteCommand('orch host label rm')
    ...
    @CLIWriteCommand('orch host ok-to-stop')
    ...
    @CLIWriteCommand('orch host maintenance enter')
    ...
    @CLIWriteCommand('orch host maintenance exit')
    ...
    @CLIWriteCommand('orch host rescan')
    ...
    @CLIReadCommand('orch device replace')
    ...
    @CLIWriteCommand('orch device zap')
    ...
    @CLIReadCommand('orch certmgr reload')
    ...
    @CLIReadCommand('orch certmgr cert ls')
    ...
    @CLIReadCommand('orch certmgr bindings ls')
    ...
    @CLIReadCommand('orch certmgr cert check')
    ...
    @CLIReadCommand('orch certmgr key ls')
    ...
    @CLIReadCommand('orch certmgr cert get')
    ...
    @CLIReadCommand('orch certmgr key get')
    ...
    @CLIWriteCommand('orch certmgr cert-key set')
    ...
    @CLIWriteCommand('orch certmgr cert set')
    ...
    @CLIWriteCommand('orch certmgr key set')
    ...
    @CLIWriteCommand('orch certmgr cert rm')
    ...
    @CLIWriteCommand('orch certmgr key rm')
    ...
    @CLIWriteCommand('orch certmgr generate-certificates')
    ...
    @CLIWriteCommand('orch prometheus set-credentials')
    ...
    @CLIWriteCommand('orch prometheus get-credentials')
    ...
    @CLIWriteCommand('orch apply osd')
    def _apply_osd(self,
    ...
    @CLIWriteCommand('orch daemon add osd')
...
"""
    ...
    @CLIWriteCommand('orch osd rm stop')
    ...
    @CLIWriteCommand('orch osd rm status')
    ...
    @CLIWriteCommand('orch osd set-spec-affinity')
    ...
    @CLIWriteCommand('orch daemon add')
    ...
    @CLIWriteCommand('orch daemon add mds')
    def _mds_add(self,
                 fs_name: str,
                 placement: Optional[str] = None,
                 inbuf: Optional[str] = None) -> HandleCommandResult:
    ...
    @CLIWriteCommand('orch daemon add rgw')
    def _rgw_add(self,
                 svc_id: str,
                 placement: Optional[str] = None,
                 _end_positional_: int = 0,
    ...
    @CLIWriteCommand('orch daemon add nfs')
    def _nfs_add(self,
                 svc_id: str,
                 placement: Optional[str] = None,
                 inbuf: Optional[str] = None) -> HandleCommandResult:
    ...
    @CLIWriteCommand('orch daemon add iscsi')
    def _iscsi_add(self,
                   pool: str,
                   api_user: str,
                   api_password: str,
    ...
    @CLIWriteCommand('orch daemon add nvmeof')
    ...
    @CLIWriteCommand('orch daemon redeploy')
    ...
    @CLIWriteCommand('orch daemon rm')
    def _daemon_rm(self,
                   names: List[str],
  ...
  ceph orch apply <service_type> [--placement=<placement_string>] [--unmanaged]
    ...
    @CLIWriteCommand('orch apply mds')
    def _apply_mds(self,
                   fs_name: str,
                   placement: Optional[str] = None,
                   dry_run: bool = False,
    ...
    @CLIWriteCommand('orch apply rgw')
    def _apply_rgw(self,
                   svc_id: str,
                   placement: Optional[str] = None,
                   _end_positional_: int = 0,
    ...
    @CLIWriteCommand('orch apply nfs')
    def _apply_nfs(self,
                   svc_id: str,
                   placement: Optional[str] = None,
                   format: Format = Format.plain,
    ...
    @CLIWriteCommand('orch apply iscsi')
    ...
    @CLIWriteCommand('orch apply mgmt-gateway')
    ...
    @CLIWriteCommand('orch apply oauth2-proxy')
    ...
    @CLIWriteCommand('orch apply nvmeof')
    ...
    @CLIWriteCommand('orch apply snmp-gateway')
    ...
    @CLIWriteCommand('orch apply jaeger')
    ...
    @CLIWriteCommand('orch apply smb')
    def _apply_smb(
        self,
        cluster_id: str,
        config_uri: str,
    ...
    @CLIWriteCommand('orch set-unmanaged')
    ...
    @CLIWriteCommand('orch set-managed')
    ...
    @CLIWriteCommand('orch set backend')
    ...
    @CLIWriteCommand('orch tuned-profile apply')
  ...
  ceph orch tuned-profile apply <profile_name> [--placement=<placement_string>] [--settings='option=value,option2=value2']
    ...
    @CLIWriteCommand('orch tuned-profile add-setting')
    ...
    @CLIWriteCommand('orch tuned-profile rm-setting')
    ...
    @CLIWriteCommand("orch tuned-profile add-settings")
    ...
    @CLIWriteCommand("orch tuned-profile rm-settings")
    ...
    @CLIWriteCommand('orch upgrade check')
    ...
    @CLIReadCommand('orch upgrade ls')
    ...
    @CLIWriteCommand('orch upgrade status')
    ...
    @CLIWriteCommand('orch upgrade start')
    ...
    @CLIWriteCommand('orch upgrade pause')
    ...
    @CLIWriteCommand('orch upgrade resume')
    ...
    @CLIWriteCommand('orch upgrade stop')
    ...
    @CLIWriteCommand('orch update service')
