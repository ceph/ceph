...
class RgwTopic(RESTController):
    ...
    def create(self, daemon_name=None, owner=None,
               topic_name: str = '', push_endpoint: Optional[str] = None,
               OpaqueData: Optional[str] = None, persistent: Optional[bool] = None,
               time_to_live: Optional[str] = None, max_retries: Optional[str] = None,
               retry_sleep_duration: Optional[str] = None, Policy: Optional[str] = None):
        rgw_topic_instance = RgwClient.instance(owner, daemon_name=daemon_name)
        return rgw_topic_instance.create_topic(topic_name=topic_name, push_endpoint=push_endpoint,
                                               OpaqueData=OpaqueData, persistent=persistent,
                                               time_to_live=time_to_live, max_retries=max_retries,
    ...
    def delete(self, topic_name: str = '', tenant: Optional[str] = None):
        rgw_topic_instance = RgwTopicmanagement()
