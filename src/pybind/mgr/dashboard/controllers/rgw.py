...
class RgwBucket(RgwRESTController):
    ...
    def set_rate_limit(self,enabled,uid, max_read_ops, max_write_ops,max_read_bytes,max_write_bytes):
        rgwBucketRateLimit_instance = RgwRateLimit()
        return rgwBucketRateLimit_instance.set_rateLimit('bucket', enabled, uid, max_read_ops, max_write_ops,max_read_bytes,max_write_bytes)
...
class RgwUser(RgwRESTController):
    ...
    def set_rate_limit(self, enabled,uid, max_read_ops, max_write_ops,max_read_bytes,max_write_bytes):
        rgwUserRateLimit_instance = RgwRateLimit()
        return rgwUserRateLimit_instance.set_rateLimit('user', enabled, uid, max_read_ops, max_write_ops,max_read_bytes,max_write_bytes)
