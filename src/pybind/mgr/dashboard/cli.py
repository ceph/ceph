...
from typing import TYPE_CHECKING, Any, Callable, Dict, Generic, Iterator, \
    List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Union, cast, \
    no_type_check

from mgr_module import CLICommandBase, HandleCommandResult, HandlerFuncType

DBCLICommand = CLICommandBase.make_registry_subtype()
DBCLIWriteCommand = DBCLICommand.Write
DBCLIReadCommand = DBCLICommand.Read
