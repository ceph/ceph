...
class TestDashboardTelemetryServicePersonaClassification(unittest.TestCase):
    ...
    Covers every system role, priority ordering, and persona count correctness.
    """
    ...
    # ------------------------------------------------------------------
    # Multiple users: counts accumulate correctly
    # ------------------------------------------------------------------

    def test_multiple_users_counts_accumulate(self):
        users = {
