...
from ..services.rbd import RbdMirroringService, RbdService, \
    RbdConfiguration, RBDSchedulerInterval, \
...
class RbdServiceTest(unittest.TestCase):
    ...
    def test_rbd_image_inherited_schedule(self, mock_get_info, mock_get_time, mock_get_interval):
        ...
        with mock.patch('dashboard.services.rbd.rbd.Image') as mock_rbd_image, \
            ...
            img_instance.mirror_image_get_info.return_value = {
                'state': rbd.RBD_MIRROR_IMAGE_ENABLED, 'primary': True
            }
            img_instance.mirror_image_get_mode.return_value = (
