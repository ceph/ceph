...
from ..services.rgw_client import NoRgwDaemonsException, RgwClient, \
    RgwRateLimit, _parse_frontend_config
...
class RgwRateLimitTest(TestCase):
    ...
    def set_rate_limit(self, mock_set_rate_limit):
        ...
        controller = RgwUser()
        result = controller.set_rate_limit(enabled='true', uid='dashboard',
                                           max_read_ops='1000', max_write_ops='1000',
                                           max_read_bytes='1080', max_write_bytes='1080')
