...
class RgwRateLimitTest(TestCase):
    ...
    def test_get_rateLimit(self, mock_get_rateLimit):
        ...
        controller = RgwUser()
        result = controller.get_rate_limit( uid='dashboard')
    ...
    def set_rate_limit(self, mock_set_rate_limit):
        ...
        controller = RgwUser()
        result = controller.set_rate_limit( enabled='true', uid='dashboard', max_read_ops='1000',max_write_ops='1000',max_read_bytes='1080', max_write_bytes='1080')
