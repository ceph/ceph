Feature: SMB management
    ...
    Goal: Test SMB management; clusters, shares, and authentication resoruces join-auth (active directory) and users and groups (standalone)
