...
import { AMQP_ACK_LEVEL, CreateTopic, END_POINT_TYPE, KAFKA_ACK_LEVEL, KAFKA_MECHANISM, Topic } from '~/app/shared/models/topic.model';
...
export class RgwCreateTopicFormComponent extends CdForm implements OnInit, AfterViewChecked {
  ...
  loadTopicData(_topicId: string) {
    this.rgwTopicService.getTopic(_topicId).subscribe((topic: Topic) => {
