...
describe('RgwUserDetailsComponent', () => {
  ...
  it('should call showKeyModal when key selection is of type S3',()=>{
    component.keysSelection.first =()=> {return {type:'S3', ref:{user:'',access_key:'', secret_key:''}}};
  ...
  it('should call showKeyModal when key selection is of type Swift',()=>{
    component.keysSelection.first =()=> {return {type:'Swift', ref:{user:'',access_key:'', secret_key:''}}};
      const s=spyOn(component['modalService'], 'show').and.callFake(() => {
        modalRef = {
          componentInstance: {
            setValues: jest.fn(),
