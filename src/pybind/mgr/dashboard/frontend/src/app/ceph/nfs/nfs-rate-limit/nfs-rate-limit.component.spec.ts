...
describe('NfsRateLimitComponent', () => {
  ...
  describe('setValidation', () => {
    it('should set validators for PerShare QoS type', () => {
      ...
      expect(component.rateLimitForm.controls['max_export_read_bw'].addValidators).toHaveBeenCalledWith(Validators.required);
      expect(component.rateLimitForm.controls['max_export_write_bw'].addValidators).toHaveBeenCalledWith(Validators.required);
    });
    ...
    it('should set validators for PerClient QoS type', () => {
      ...
      expect(component.rateLimitForm.controls['max_client_read_bw'].addValidators).toHaveBeenCalledWith(Validators.required);
      expect(component.rateLimitForm.controls['max_client_write_bw'].addValidators).toHaveBeenCalledWith(Validators.required);
    });

    it('should set validators for PerSharePerClient QoS type', () => {
      component.qosTypeVal = 'PerSharePerClient';
      component.createForm();
      jest.spyOn(component.rateLimitForm.controls['max_export_read_bw'], 'addValidators');
      jest.spyOn(component.rateLimitForm.controls['max_export_write_bw'], 'addValidators');
      jest.spyOn(component.rateLimitForm.controls['max_client_read_bw'], 'addValidators');
  ...
  describe('showMaxBwNote', () => {
    ...
    it('should remove validators when QoS is disabled', () => {
      ...
      expect(component.rateLimitForm.controls['max_export_read_bw'].removeValidators).toHaveBeenCalledWith(Validators.required);
      expect(component.rateLimitForm.controls['max_export_write_bw'].removeValidators).toHaveBeenCalledWith(Validators.required);
      expect(component.rateLimitForm.controls['max_client_read_bw'].removeValidators).toHaveBeenCalledWith(Validators.required);
      expect(component.rateLimitForm.controls['max_client_write_bw'].removeValidators).toHaveBeenCalledWith(Validators.required);
    });
  });
  ...
  describe('setFormData', () => {
    ...
    it('should set form data correctly', () => {
      const data = {
        enable_qos: true,
        qos_type: 'PerShare',
        max_export_read_bw: '100MB/s',
        max_export_write_bw: '200MB/s',
        max_client_read_bw: '300MB/s',
        max_client_write_bw: '400MB/s'
      };
  ...
  describe('rateLimitBytesMaxSizeValidator', () => {
    it('should return validation error for invalid input', () => {
      ...
      jest.spyOn(FormatterService.prototype, 'performValidation').mockReturnValue({ rateByteMaxSize: true });
  ...
  describe('getQosTypeHelper', () => {
    it('should return the help text for the given qosType', () => {
      component.qosType = [{ value: 'PerShare', help: 'PerShare help text' }];
    ...
    it('should return an empty string if qosType is not found', () => {
      component.qosType = [{ value: 'PerClient', help: 'PerClient help text' }];
      const result = component.getQosTypeHelper('PerShare');
      expect(result).toBe('');
    });
  });
  ...
  describe('_getRateLimitArgs', () => {
    ...
    it('should return the correct rate limit args for PerSharePerClient', () => {
      component.qosTypeVal = 'PerSharePerClient';
      component.rateLimitForm.get('enable_qos')?.setValue(true);
      component.rateLimitForm.get('qos_type')?.setValue('PerSharePerClient');
      component.rateLimitForm.get('max_export_read_bw')?.setValue('100MB/s');
      component.rateLimitForm.get('max_export_write_bw')?.setValue('200MB/s');
      component.rateLimitForm.get('max_client_read_bw')?.setValue('300MB/s');
      component.rateLimitForm.get('max_client_write_bw')?.setValue('400MB/s');
      ...
      expect(result.enable_qos).toBe(true);
      expect(result.qos_type).toBe('PerSharePerClient');
      expect(result.max_export_read_bw).toBe(100);
      expect(result.max_export_write_bw).toBe(100);
      expect(result.max_client_read_bw).toBe(100);
      expect(result.max_client_write_bw).toBe(100);
