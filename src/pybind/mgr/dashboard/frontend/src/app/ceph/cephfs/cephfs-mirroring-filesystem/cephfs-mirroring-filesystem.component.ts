...
export class CephfsMirroringFilesystemComponent implements OnInit {
  ...
  constructor(private cephfsService: CephfsService, private dimlessBinaryPipe: DimlessBinaryPipe) {}

  ngOnInit(): void {
    this.columns = [
      { name: 'Filesystem Name', prop: 'name', flexGrow: 2 },
      { name: 'Used', prop: 'used', flexGrow: 1, pipe: this.dimlessBinaryPipe },
      {
        prop: 'pools',
      ...
      { name: 'Status', prop: 'mdsStatus', flexGrow: 0.8, cellTemplate: this.mdsStatus },
