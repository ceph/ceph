...
describe('RgwCreateTopicFormComponent', () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: { show: jest.fn() } // Mock NotificationService
        }
      ],
  ...
  it('should handle select owner change', () => {
    const event = { target: { value: 'new-owner' } } as any;
    component.onSelectOwner(event);

    expect(component.selectOwner).toBe('new-owner');
  });
  ...
  it('should handle verify SSL change', () => {
    component.onVerifySslChange(true);

    expect(component.verify_sslflag).toBe(true);
  });

  it('should handle use SSL change', () => {
    component.onUseSslChange(true);

    expect(component.useSslFlag).toBe(true);
  });

  it('should handle level change', () => {
    component.onLevelChange(true);
    expect(component.levelFlag).toBe(true);
  });
});
