...
export class ErasureCodeProfileFormModalComponent
  ...
  createForm() {
    this.form = this.formBuilder.group({
      ...
      crushNumFailureDomains: [0, CdValidators.requiredIf({crushOsdsPerFailureDomain: {op: 'minValue', 'arg1': 1}})],
      crushOsdsPerFailureDomain: [0, CdValidators.requiredIf({crushNumFailureDomains: {op: 'minValue', 'arg1': 1}})],
