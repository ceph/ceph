...
export class MultiClusterFormComponent implements OnInit, OnDestroy {
  ...
  createForm() {
    this.remoteClusterForm = new CdFormGroup({
      ...
      password: new FormControl(null, CdValidators.custom('requiredNotEdit', (value: string) => { return this.action !== 'edit' && !value})),
      ...
      case 'edit':
        this.subs.add(
          this.multiClusterService
            .editCluster(this.cluster.name, url, clusterAlias, this.cluster.user, ssl, ssl_certificate)
            .subscribe({
              ...commonSubscribtion,
