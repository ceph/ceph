...
export const JOINAUTH_PATH = 'cephfs/smb/active-directory';

@Component({
  selector: 'cd-smb-join-auth-list',
  templateUrl: './smb-join-auth-list.component.html',
  styleUrls: ['./smb-join-auth-list.component.scss'],
  providers: [{ provide: URLBuilderService, useValue: new URLBuilderService(JOINAUTH_PATH) }]
})
    ...
    this.modalService.show(DeleteConfirmationModalComponent, {
      ...
      submitActionObservable: () =>
        this.taskWrapper.wrapTaskAroundCall({
          task: new FinishedTask(`${JOINAUTH_PATH}/${URLVerbs.DELETE}`, {
            authId: authId
          }),
