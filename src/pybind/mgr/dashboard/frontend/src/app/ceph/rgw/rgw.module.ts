...
import { ButtonModule, CheckboxModule, ComboBoxModule, GridModule, IconModule, InputModule, LoadingModule, ModalModule, NumberModule, RadioModule, SelectModule, TooltipModule } from 'carbon-components-angular';
