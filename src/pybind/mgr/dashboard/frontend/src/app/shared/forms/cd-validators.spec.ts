  ...
  describe('bucket', () => {
    ...
    describe('endpointValidator', () => {
      it('should return null for a valid URL with port', () => {
        ...
        expect(CdValidators.endpointValidator(control)).toBeNull();
      });
      ...
      it('should return an error object for a URL without a port', () => {
        const control = new UntypedFormControl('https://example.com');
        expect(CdValidators.endpointValidator(control)).toEqual({ invalidEndpoint: true });
      });

      it('should return an error object for multiple invalid URLs', () => {
        const control = new UntypedFormControl('https://example.com,http://invalid-url');
        expect(CdValidators.endpointValidator(control)).toEqual({ invalidEndpoint: true });
      });
      ...
      it('should return an error object for an IP address without a port', () => {
