...
export class CriticalConfirmationModalComponent extends BaseModal implements OnInit {
  ...
  constructor(
    @Inject('itemNames') public itemNames: string[],
    @Inject('itemDescription') public itemDescription: 'entry',
    ...
    @Optional() @Inject('submitActionObservable') public submitActionObservable?: () => Observable<any>,
    @Optional() @Inject('callBackAtionObservable') public callBackAtionObservable?: () => Observable<any>,
  ) {
    super();
