...
describe('RgwRoleService', () => {
  ...
  it('should call list with account_id', () => {
    ...
    const req = httpTesting.expectOne('api/rgw/roles?account_id=test-account');
    expect(req.request.method).toBe('GET');
  });

  it('should call get with account_id', () => {
    service.get('test-role', 'test-account').subscribe();
    const req = httpTesting.expectOne('api/rgw/roles/test-role?account_id=test-account');
    expect(req.request.method).toBe('GET');
  });
  ...
  it('should call create', () => {
    ...
    const req = httpTesting.expectOne('api/rgw/roles');
  ...
  it('should call update', () => {
    ...
    service.update('test-role', payload).subscribe();
    const req = httpTesting.expectOne('api/rgw/roles');
