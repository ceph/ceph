...
describe('MgrModuleService', () => {
  ...
  describe('should update module state', () => {
    ...
    beforeEach(() => {
      ...
      component.table = jasmine.createSpyObj('TableComponent', ['refreshBtn']);
    ...
    it('should enable module and refresh table', fakeAsync(() => {
      ...
      service.updateModuleState(selected.name, selected.enabled, component.table);
    ...
    it('should disable module and refresh table', fakeAsync(() => {
