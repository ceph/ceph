...
from ..cli import DBCLICommand, DBCLIReadCommand, DBCLIWriteCommand
...
@DBCLIReadCommand('dashboard iscsi-gateway-list')
...
@DBCLIWriteCommand('dashboard iscsi-gateway-add')
...
@DBCLIWriteCommand('dashboard iscsi-gateway-rm')
