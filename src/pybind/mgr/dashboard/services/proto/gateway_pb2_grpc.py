...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_thread_stats = channel.unary_unary(
                ...
                request_serializer=dashboard_dot_services_dot_proto_dot_gateway__pb2.get_spdk_thread_stats_req.SerializeToString,
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_thread_stats': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=dashboard_dot_services_dot_proto_dot_gateway__pb2.get_spdk_thread_stats_req.FromString,
...
class Gateway(object):
    ...
    def get_thread_stats(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Gateway/get_thread_stats',
            dashboard_dot_services_dot_proto_dot_gateway__pb2.get_spdk_thread_stats_req.SerializeToString,
