...
class UserPersonaDistribution(TypedDict):  # pylint: disable=inherit-non-class
    admin: int
    read_only: int
...
class TelemetryMetricsResponse(TypedDict):  # pylint: disable=inherit-non-class
...
class DashboardTelemetryService:
    ...
    ROLE_TO_PERSONA = {
        ...
        'pool-manager': 'block_storage_operator',
        'cephfs-manager': 'file_system_operator',
        'ganesha-manager': 'file_system_operator',
        'smb-manager': 'file_system_operator',
