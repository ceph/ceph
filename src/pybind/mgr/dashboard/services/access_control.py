...
@DBCLIWriteCommand('dashboard set-login-credentials')
...
@DBCLIReadCommand('dashboard ac-role-show')
...
@DBCLIWriteCommand('dashboard ac-role-create')
...
@DBCLIWriteCommand('dashboard ac-role-delete')
...
@DBCLIWriteCommand('dashboard ac-role-add-scope-perms')
...
@DBCLIWriteCommand('dashboard ac-role-del-scope-perms')
...
@DBCLIReadCommand('dashboard ac-user-show')
...
@DBCLIWriteCommand('dashboard ac-user-create')
@CLICheckNonemptyFileInput(desc=DEFAULT_FILE_DESC)
...
@DBCLIWriteCommand('dashboard ac-user-enable')
...
@DBCLIWriteCommand('dashboard ac-user-disable')
...
@DBCLIWriteCommand('dashboard ac-user-delete')
...
@DBCLIWriteCommand('dashboard ac-user-set-roles')
...
@DBCLIWriteCommand('dashboard ac-user-add-roles')
...
@DBCLIWriteCommand('dashboard ac-user-del-roles')
...
@DBCLIWriteCommand('dashboard ac-user-set-password')
@CLICheckNonemptyFileInput(desc=DEFAULT_FILE_DESC)
...
@DBCLIWriteCommand('dashboard ac-user-set-password-hash')
@CLICheckNonemptyFileInput(desc=DEFAULT_FILE_DESC)
...
@DBCLIWriteCommand('dashboard ac-user-set-info')
