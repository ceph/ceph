...
class CephService(object):
    ...
    @classmethod
    def set_encryption_config(cls, encryption_type, kms_provider, config: Union[VaultConfig, KmipConfig], daemon_name):
...
def _get_conf_keys(fields: List[str], req_fields: List[str], encryption_type: str, backend: str, daemon_name: str) -> Dict[str, str]:
    config = {}
    for field in fields:
...
def _set_defaults_in_encryption_configs(config: any, encryption_type: str, kms_provider: str):
