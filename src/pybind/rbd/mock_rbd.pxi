...
cdef nogil:
    ...
    ctypedef enum rbd_snap_mirror_sync_state_t:
        _RBD_MIRROR_GROUP_SNAP_SYNC_UNKNOWN  "RBD_MIRROR_GROUP_SNAP_SYNC_UNKNOWN"
        _RBD_MIRROR_GROUP_SNAP_SYNC_INPROGRESS  "RBD_MIRROR_GROUP_SNAP_SYNC_INPROGRESS"
        _RBD_MIRROR_GROUP_SNAP_SYNC_COMPLETE  "RBD_MIRROR_GROUP_SNAP_SYNC_COMPLETE"
