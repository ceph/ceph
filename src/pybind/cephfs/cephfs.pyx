...
class CptreeWorker:
    ...
    def __init__(self, fs, src_path, dst_path, should_sync_attrs=False,
                 cp_src_dir=False, should_cancel=False, suppress_errors=False):
        self.fs = fs
    ...
    def start(self):
        ...
        try:
            ...
            self.stack.append(CptreeDir(self.fs, self.src_path, dst_path, None,
                                        should_sync_attrs=self.should_sync_attrs,
...
class CptreeDir:
    ...
    def copy_dir(self):
        ...
        if self.should_sync_attrs:
            sync_attrs(self.fs, self.parent_dir_src_fd,
                       self.parent_dir_dst_fd, self.dst_rel_path)
