...
do
 ...
 do
   ...
   ssh root@cosd$host cd $HOME/ceph/src \; ulimit -c unlimited \; ./cosd $devm -d --debug_ms 1 --debug_osd 20 --lockdep 1 # --debug_filestore 10 --debug_ebofs 30 --osd_heartbeat_grace 300
