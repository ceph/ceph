...
#ifndef CEPH_OS_BLUESTORE_LINEARALLOCATOR_H
#define CEPH_OS_BLUESTORE_LINEARALLOCATOR_H
...
class LinearAllocator : public Allocator {
  ...
  btree_interval_set<uint64_t,allocator> free;  ///< leading-edge copy
...
public:
  LinearAllocator(CephContext* cct);
