...
void BlueStore::_init_logger()
{
  ...
  b.add_time_avg(l_bluestore_state_prepare_lat, "state_prepare_lat",
		 ...
		 "pr_l", PerfCountersBuilder::PRIO_INTERESTING);
  ...
  b.add_time_avg(l_bluestore_csum_lat, "verify_csum_lat",
    "Average checksum verification latency");
  ...
  b.add_time_avg(l_bluestore_remove_lat, "remove_lat",
    ...
    "D_l", PerfCountersBuilder::PRIO_INTERESTING);
  //****************************************
