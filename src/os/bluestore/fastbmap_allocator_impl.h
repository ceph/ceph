...
public:
  ...
  // unbounded). Each run is clipped to the window. Returns the L0 position to
  // resume at: >= l0_pos_end once the window is exhausted, otherwise the first
  // unit past the last emitted run.
