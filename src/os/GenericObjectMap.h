...
private:
  ...
  public:
    ...
    std::tr1::shared_ptr<GenericObjectMapIteratorImpl> parent_iter;
    KeyValueDB::Iterator key_iter;
    KeyValueDB::Iterator complete_iter;

    /// cur_iter points to currently valid iterator
    std::tr1::shared_ptr<ObjectMap::ObjectMapIteratorImpl> cur_iter;
    int r;
  ...
  typedef std::tr1::shared_ptr<GenericObjectMapIteratorImpl> GenericObjectMapIterator;
