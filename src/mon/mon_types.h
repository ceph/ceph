...
namespace ceph {
  namespace features {
    namespace mon {
      ...
      constexpr mon_feature_t FEATURE_VAMPIRE(    (1ULL << 13));  
...
{
  if (f.contains_all(ceph::features::mon::FEATURE_VAMPIRE)) {
    return ceph_release_t::vampire;
  }
