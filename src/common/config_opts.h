...
OPTION(crush_location_hook_timeout, OPT_U32, 10)
...
OPTION(rocksdb_cache_size, OPT_U32, 128*1024*1024)  // default leveldb cache size
OPTION(rocksdb_block_size, OPT_U32, 4*1024)  // default rocksdb block size
...
OPTION(bdev_inject_crash, OPT_U32, 0)  // if N>0, then ~ 1/N IOs will complete before we crash on flush.
OPTION(bdev_inject_crash_flush_delay, OPT_U32, 2) // wait N more seconds on flush
OPTION(bdev_aio, OPT_BOOL, true)
OPTION(bdev_aio_poll_ms, OPT_U32, 250)  // milliseconds
OPTION(bdev_aio_max_queue_depth, OPT_U32, 32)
OPTION(bdev_block_size, OPT_U32, 4096)
...
OPTION(bluestore_freelist_blocks_per_key, OPT_U32, 128)
...
OPTION(bluestore_wal_threads, OPT_U32, 4)
OPTION(bluestore_wal_thread_timeout, OPT_U32, 30)
OPTION(bluestore_wal_thread_suicide_timeout, OPT_U32, 120)
...
OPTION(bluestore_nid_prealloc, OPT_U32, 1024)
OPTION(bluestore_overlay_max_length, OPT_U32, 65536)
OPTION(bluestore_overlay_max, OPT_U32, 0)
...
OPTION(bluestore_debug_small_allocations, OPT_U32, 0)
OPTION(bluestore_debug_freelist, OPT_BOOL, false)
OPTION(bluestore_debug_prefill, OPT_FLOAT, 0)
OPTION(bluestore_debug_prefragment_max, OPT_U32, 1048576)
...
OPTION(kstore_default_stripe_size, OPT_U32, 65536)
