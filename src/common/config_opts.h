...
OPTION(function_tracing, OPT_BOOL, false) // true if LTTng-UST tracepoints should be enabled
OPTION(oid_tracing, OPT_BOOL, false) // true if LTTng-UST tracepoints should be enabled
