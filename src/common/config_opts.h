...
OPTION(rgw_keystone_admin_user, OPT_STR, "")  // keystone admin token (shared secret)
OPTION(rgw_keystone_admin_password, OPT_STR, "")  // keystone admin token (shared secret)
OPTION(rgw_keystone_admin_tenant, OPT_STR, "")  // keystone admin token (shared secret)
