...
protected:
  ...
  int fetch_bench_metadata(const std::string& metadata_file, uint64_t* object_size, int* num_objects, int* prevPid);
...
public:
  ...
  int aio_bench(
    ...
    int concurrentios, uint64_t op_size, bool cleanup, const std::string& run_name, bool no_verify=false);
