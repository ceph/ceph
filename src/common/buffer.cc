...
# define bendl std::endl; }
  ...
  static std::atomic<unsigned> buffer_total_alloc;
  static std::atomic<int64_t> buffer_history_alloc_bytes;
  static std::atomic<int64_t> buffer_history_alloc_num;
  ...
  static std::atomic<unsigned> buffer_cached_crc;
  static std::atomic<unsigned> buffer_cached_crc_adjusted;
  ...
  static std::atomic<unsigned> buffer_c_str_accesses;
  ...
  static std::atomic<unsigned> buffer_max_pipe_size;
