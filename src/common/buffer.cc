...
# define bendl std::endl; }
  ...
  // the 16k came after MOSDPing::encode_payload() which was the initial user
  // of the zero-dedup optimization. Quoting the explanation:
  //
  ...
  //
  // all static variables are zero-initialized unless it's constant-initialized.
