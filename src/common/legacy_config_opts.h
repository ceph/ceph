...
OPTION(bluestore_sequential_io_max_cutoff_bytes, OPT_U64)
OPTION(bluestore_sequential_io_max_queue_size, OPT_U64)
OPTION(bluestore_sequential_io_max_deferred_ops, OPT_U64)
