...
public: // Methods
  ...
  static void record_wait_time(
      ...
      std::chrono::duration<long, std::ratio<1, 1000000000>> wait_time,
      LockMode mode);
...
public: // Constants and types
  ...
  public: // Member variables
    ...
    ///
    std::array<mono_clock::duration, static_cast<size_t>(LockMode::COUNT)>
        m_wait_duration;
...
public: // Methods
  ...
  ///
  static int start(mono_clock::duration threshold);
  ...
  ///
  static std::pair<LockStatEntryTableT, mono_clock::duration> show();
...
public: // member variables
  ...
  ///
  std::atomic<mono_clock::duration> m_max_wait;
...
public: // Methods
  ...
  ///
  void
  record_wait_time(mono_clock::duration wait_time, LockMode mode) const
  {
...
protected: // Data
  ...
  ///
  static std::atomic<mono_clock::time_point> g_start_cycles;

  ///
  /// @brief record wait time >= this many cycles
  ///
  static std::atomic<mono_clock::duration> g_threshold_cycles;
  static std::atomic<mono_clock::duration> g_threshold_cycles_when;
};
