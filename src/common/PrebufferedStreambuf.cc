...
struct unique_PrebufferedStreambuf
{
  ...
  unique_PrebufferedStreambuf() : m_streambuf(new PrebufferedStreambuf()) {}
...
PrebufferedStreambuf::~PrebufferedStreambuf()
{
...
void PrebufferedStreambuf::finish()
{
...
PrebufferedStreambuf* PrebufferedStreambuf::get_streambuf(prebuffered_data* data)
{
  PrebufferedStreambuf* streambuf;
  ...
  if (t_streambuf.m_streambuf == nullptr /*this can happen only on process cleanup*/
    ...
    streambuf = new PrebufferedStreambuf();
  } else {
