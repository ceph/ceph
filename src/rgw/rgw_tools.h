...
int rgw_init_ioctx(librados::Rados *rados, const rgw_pool& pool,
		   ...
		   bool create = false,
		   bool mostly_omap = false, const jaeger_tracing::Span& parent_span = NULL);
...
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      ...
                      optional_yield y, int flags = 0, const jaeger_tracing::Span& parent_span = nullptr);
int rgw_rados_operate(librados::IoCtx& ioctx, const std::string& oid,
                      librados::ObjectWriteOperation *op, optional_yield y,
		      int flags = 0, const jaeger_tracing::Span& parent_span = nullptr);
