...
public:
  ...
  rgw_raw_obj get_raw_obj(const RGWZoneGroup& zonegroup, const RGWZoneParams& zone) const;
...
public:
  ...
  public:
    ...
    rgw_raw_obj get_cur_obj(const RGWZoneGroup& zonegroup,
                            const RGWZoneParams& zone_params) const {
      return cur_obj.get_raw_obj(zonegroup, zone_params);
    }
    rgw_raw_obj get_cur_obj(RGWSI_Zone* zone_svc) const {
      return cur_obj.get_raw_obj(zone_svc);
    }
