...
protected:
  int init_permissions(RGWOp* op, const jaeger_tracing::Span& parent_span = nullptr) override {return 0;}
  int read_permissions(RGWOp* op, const jaeger_tracing::Span& parent_span = nullptr) override {return 0;}
