...
public:
  ...
  virtual int put_script(const DoutPrefixProvider* dpp, optional_yield y, const std::string& key, const rgw::lua::LuaScriptMeta& new_script, const std::optional<rgw::lua::LuaRuntimeMeta>& scripts_meta) = 0;
  /** Delete a script named with the given key from the backing store */
  virtual int del_script(const DoutPrefixProvider* dpp, optional_yield y, const std::string& old_script_key, const std::string& meta_key, const std::optional<std::string> optional_script_name, const std::optional<rgw::lua::LuaRuntimeMeta>& scripts_meta) = 0;
  /** Add a lua package */
