...
class RGWStore {
  public:
    ...
    virtual int log_op(const DoutPrefixProvider *dpp, string& oid, bufferlist& bl) = 0;
    ...
    virtual int meta_list_keys_init(const DoutPrefixProvider *dpp, const string& section, const string& marker, void** phandle) = 0;
