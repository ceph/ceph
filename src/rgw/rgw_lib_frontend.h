...
namespace rgw {
  ...
  public:
    ...
    /* "regular" requests */
    void handle_request(const DoutPrefixProvider *dpp, RGWRequest* req, bool null_verid) override; // async handler, deletes req
    int process_request(RGWLibRequest* req, bool null_verid);
    int process_request(RGWLibRequest* req, RGWLibIO* io, bool null_verid);
  ...
  public:
    ...
    inline int execute_req(RGWLibRequest* req, bool null_verid) {
      return static_cast<RGWLibProcess*>(pprocess)->process_request(req, null_verid); // !async
    }
