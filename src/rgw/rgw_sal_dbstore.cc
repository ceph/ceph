...
namespace rgw::sal {
  ...
  int DBObject::set_obj_attrs(const DoutPrefixProvider* dpp, Attrs* setattrs, Attrs* delattrs, optional_yield y, rgw_log_op_info* log_op_info, uint32_t flags)
  {
    Attrs empty;
  ...
  int DBObject::modify_obj_attrs(const char* attr_name, bufferlist& attr_val, optional_yield y, const DoutPrefixProvider* dpp, rgw_log_op_info* log_op_info, uint32_t flags)
  {
    ...
    return set_obj_attrs(dpp, &state.attrset, nullptr, y, log_op_info, flags);
  }

  int DBObject::delete_obj_attrs(const DoutPrefixProvider* dpp, const char* attr_name, optional_yield y, rgw_log_op_info *log_op_info, uint32_t flags)
  {
    Attrs rmattr;
    bufferlist bl;
                       ...
                       uint32_t flags)
  {
    ...
    parent_op.meta.log_op_info = log_op_info;
