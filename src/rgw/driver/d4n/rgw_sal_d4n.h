...
class D4NFilterDriver : public FilterDriver {
  private:
    ...
    std::shared_ptr<rgw::d4n::MultiRedisPoolManager> redis_pool_manager;
  ...
  public:
    ...
    std::shared_ptr<rgw::d4n::MultiRedisPoolManager> get_redis_pool_manager() { return redis_pool_manager; }
