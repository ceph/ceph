...
namespace rgw::dedup {
                                ...
                                std::string *oid)
  {
    ...
    *oid = build_oid(rb.bucket_id, obj_name);
    rgw_pool data_pool;
                              ...
                              std::string *oid)
  {
    ...
    return get_ioctx_internal(dpp, driver, rados, p_rec->obj_name, b, p_ioctx, oid);
  }
                                      ...
                                      md5_stats_t *p_stats)
  {
    ...
    while (p != manifest.obj_end(dpp)) {
      ...
      if (offset == 0) {
        ...
        // TBD: maybe should take the instance/ns from the first tail-object ?
                                    ...
                                    md5_stats_t *p_stats)
  {
    ...
    ret = get_ioctx_internal(dpp, driver, rados, tail_name, *p_bucket, &tail_ioctx,
                             &tail_oid);
    if (unlikely(ret != 0)) {
