...
int MotrStore::create_customer_managed_policy(const DoutPrefixProvider* dpp,
                optional_yield y, const rgw::IAM::ManagedPolicyInfo& info, bool exclusive)
{
  return -ENOTSUP;
}

int MotrStore::get_customer_managed_policy(const DoutPrefixProvider* dpp,
                          optional_yield y,
...
int MotrStore::delete_customer_managed_policy(const DoutPrefixProvider* dpp,
                          optional_yield y,
                          std::string_view account,
                          std::string_view name) 
{
