...
class MotrLuaManager : public StoreLuaManager {
  ...
  virtual int list_scripts(const DoutPrefixProvider* dpp, optional_yield y, RGWObjVersionTracker* objv, const std::string& key, std::vector<std::string>& scripts) override;
