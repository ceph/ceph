...
#if 0
struct POSIXUserDBOpBucketInfo {
...
struct POSIXUserDBOpObjectInfo {
...
struct POSIXUserDBOpObjectDataInfo {
  RGWObjState state;
  uint64_t part_num;
...
struct POSIXUserDBOpLCHeadInfo {
  std::string index;
  rgw::sal::LCHead head;
};

struct POSIXUserDBOpLCEntryInfo {
  std::string index;
...
struct POSIXUserDBOpInfo {
  ...
  POSIXUserDBOpUserInfo user;
  std::string query_str;
#if 0
  POSIXUserDBOpBucketInfo bucket;
  POSIXUserDBOpObjectInfo obj;
  POSIXUserDBOpObjectDataInfo obj_data;
  POSIXUserDBOpLCHeadInfo lc_head;
  POSIXUserDBOpLCEntryInfo lc_entry;
#endif
  uint64_t list_max_count;
};

#if 0
struct DBOpParams : DBOpParams {
  CephContext *cct;
...
#if 0
struct POSIXUserDBOpBucketPrepareInfo {
  ...
  static constexpr const char* placement_name = ":placement_name";
  static constexpr const char* placement_storage_class = ":placement_storage_class";
  /* ownerid - maps to POSIXUserDBOpUserPrepareInfo */
...
struct POSIXUserDBOpObjectPrepareInfo {
...
struct POSIXUserDBOpObjectDataPrepareInfo {
...
struct POSIXUserDBOpLCEntryPrepareInfo {
...
struct POSIXUserDBOpLCHeadPrepareInfo {
  static constexpr const char* index = ":index";
...
struct POSIXUserDBOpPrepareInfo {
  POSIXUserDBOpUserPrepareInfo user;
  std::string_view query_str; // view into POSIXUserDBOpInfo::query_str
#if 0
  POSIXUserDBOpBucketPrepareInfo bucket;
  POSIXUserDBOpObjectPrepareInfo obj;
  POSIXUserDBOpObjectDataPrepareInfo obj_data;
  POSIXUserDBOpLCHeadPrepareInfo lc_head;
  POSIXUserDBOpLCEntryPrepareInfo lc_entry;
#endif
  static constexpr const char* list_max_count = ":list_max_count";
};

struct POSIXUserDBOpPrepareParams {
  /* Tables */
  std::string user_table;
#if 0
  std::string bucket_table;
...
struct POSIXUserDBOps : DBOps {
  std::shared_ptr<class SQLInsertUser> InsertUser;
  std::shared_ptr<class SQLRemoveUser> RemoveUser;
  std::shared_ptr<class SQLGetUser> GetUser;
#if 0
...
class POSIXUserDBOp : public SQLiteDB {
  private:
  ...
  public:
    POSIXUserDBOp(std::string db_name, CephContext *_cct) : SQLiteDB(db_name, _cct) {}
    POSIXUserDBOp(sqlite3 *dbi, std::string db_name, CephContext *_cct) : SQLiteDB(dbi, db_name, _cct) {}
...
class InsertPOSIXUserOp : public SQLInsertUser {
  ...
  public:
    virtual ~InsertPOSIXUserOp() {}

    static std::string Schema(POSIXUserDBOpPrepareParams &params) {
...
class GetPOSIXUserOp: public SQLGetUser {
  private:
    /* If below query columns are updated, make sure to update the indexes
     * in list_user() cbk in sqlitePOSIXUserDB.cc */
...
#if 0
class InsertBucketOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class UpdateBucketOp: virtual public POSIXUserDBOp {
  private:
...
class RemoveBucketOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class GetBucketOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query = "SELECT  \
                          BucketName, Tenant, Marker, BucketID, Size, SizeRounded, CreationTime, \
                          Count, PlacementName, PlacementStorageClass, OwnerID, Flags, Zonegroup, \
...
class ListUserBucketsOp: virtual public POSIXUserDBOp {
  private:
...
class PutObjectOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "INSERT OR REPLACE INTO '{}' \
...
class DeleteObjectOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class GetObjectOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "SELECT  \
      ObjName, ObjInstance, ObjNS, BucketName, ACLs, IndexVer, Tag, \
...
class ListBucketObjectsOp: virtual public POSIXUserDBOp {
  private:
    // once we have stats also stored, may have to update this query to join
    // these two tables.
    static constexpr std::string_view Query =
...
class ListVersionedObjectsOp: virtual public POSIXUserDBOp {
  private:
    // once we have stats also stored, may have to update this query to join
    // these two tables.
    static constexpr std::string_view Query =
...
class UpdateObjectOp: virtual public POSIXUserDBOp {
  private:
    // Updates Omap
...
class PutObjectDataOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "INSERT OR REPLACE INTO '{}' \
...
class UpdateObjectDataOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "UPDATE '{}' \
...
class GetObjectDataOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "SELECT  \
      ObjName, ObjInstance, ObjNS, BucketName, ObjID, MultipartPartStr, PartNum, Offset, Size, Mtime, Data \
...
class DeleteObjectDataOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class DeleteStaleObjectDataOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class InsertLCEntryOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "INSERT OR REPLACE INTO '{}' \
...
class RemoveLCEntryOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class GetLCEntryOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query = "SELECT  \
                          LCIndex, BucketName, StartTime, Status \
...
class ListLCEntriesOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query = "SELECT  \
                          LCIndex, BucketName, StartTime, Status \
...
class InsertLCHeadOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
      "INSERT OR REPLACE INTO '{}' \
...
class RemoveLCHeadOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query =
...
class GetLCHeadOp: virtual public POSIXUserDBOp {
  private:
    static constexpr std::string_view Query = "SELECT  \
                          LCIndex, Marker, StartDate \
                          from '{}' where LCIndex = {}";
...
struct POSIXUserDBOLHInfo {
  rgw_obj target;
  bool removed;
  POSIXUserDBOLHInfo() : removed(false) {}
...
WRITE_CLASS_ENCODER(POSIXUserDBOLHInfo)
#endif
...
class POSIXUserDB : public SQLiteDB {
  ...
  public:
...
#if 0
    POSIXUserDB(CephContext *_cct) : SQLiteDB(_cct),  
    db_name("default_db"),
    user_table(db_name+"_user_table"),
    bucket_table(db_name+"_bucket_table"),
    quota_table(db_name+"_quota_table"),
    ...
    const std::string getPOSIXUserDBname() { return db_name; }
    const std::string getPOSIXUserDBfile() { return db_name + ".db"; }
    ...
    struct DBOps dbops; // POSIXUserDB operations, make it private?
    ...
    std::shared_ptr<class DBOp> getPOSIXUserDBOp(const DoutPrefixProvider *dpp, std::string_view Op, const DBOpParams *params);
#if 0
    ...
    virtual void *openDB(const DoutPrefixProvider *dpp);
    virtual int closeDB(const DoutPrefixProvider *dpp) { return 0; }
    virtual int createTables(const DoutPrefixProvider *dpp) { return 0; }
#endif
    virtual int InitializeDBOps(const DoutPrefixProvider *dpp) { 
      (void)SQLiteDB::createTables(dpp);
    ...
    virtual int ListAllObjects(const DoutPrefixProvider *dpp, DBOpParams *params) { return 0; }
#endif
    ...
    struct raw_obj {
      ...
      raw_obj(POSIXUserDB* _db) {
        db = _db;
      }

      raw_obj(POSIXUserDB* _db, std::string& _bname, std::string& _obj_name, std::string& _obj_instance,
      ...
      raw_obj(POSIXUserDB* _db, std::string& oid) {
        int r;
    ...
    public:
      GC(const DoutPrefixProvider *_dpp, POSIXUserDB* _db) :
            dpp(_dpp), db(_db) {}
	...
	cv.notify_one();
      ...
      friend class POSIXUserDB;
    };
    std::unique_ptr<POSIXUserDB::GC> gc_worker;
    ...
    class Bucket {
      ...
      public:
        Bucket(POSIXUserDB *_store, const RGWBucketInfo& _binfo) : store(_store), bucket_info(_binfo) {}
        POSIXUserDB *get_store() { return store; }
	  ...
	  bool allow_unordered;
        ...
        explicit List(POSIXUserDB::Bucket *_target) : target(_target) {}
    ...
    class Object {
      ...
      public:
      Object(POSIXUserDB *_store, const RGWBucketInfo& _bucket_info, const rgw_obj& _obj) : store(_store), bucket_info(_bucket_info),
      obj(_obj),
      versioning_disabled(false),
      bs_initialized(false) {}

      Object(POSIXUserDB *_store, const RGWBucketInfo& _bucket_info, const rgw_obj& _obj, const std::string& _obj_id) : store(_store), bucket_info(_bucket_info), obj(_obj), obj_id(_obj_id) {}

      struct Read {
        POSIXUserDB::Object *source;
	  ...
	  std::map<std::string, bufferlist> *attrs;
        ...
        explicit Read(POSIXUserDB::Object *_source) : source(_source) {}
	  ...
	  std::map<std::string, bufferlist>* rmattrs;
        ...
        explicit Write(POSIXUserDB::Object *_target) : target(_target) {}
      ...
      struct Delete {
        ...
        explicit Delete(POSIXUserDB::Object *_target) : target(_target) {}
...
struct db_get_obj_data {
  ...
  db_get_obj_data(POSIXUserDB* db, RGWGetDataCB* cb, uint64_t offset) :
