    ...
    class Object {
      ...
      struct Delete {
        ...
        struct DeleteParams {
          ...
          DeleteParams() : versioning_status(0), olh_epoch(0), bilog_flags(0), remove_objs(NULL), high_precision_time(false), zones_trace(nullptr), log_zonegroup(nullptr), abortmp(false), parts_accounted_size(0) {}
        } params;
