...
class StoreBucket : public Bucket {
  ...
  public:
    ...
    int set_bucket_logging_source(const std::string& prefix, const DoutPrefixProvider *dpp, optional_yield y) override {return 0;}
    int remove_bucket_logging_source(const std::string& prefix, const DoutPrefixProvider *dpp, optional_yield y) override {return 0;}
