...
class lease_state : public ceph::async::service_list_base_hook {
  ...
  ceph::async::co_waiter<void, boost::asio::any_io_executor> waiter;
 ...
 public:
  ...
  boost::asio::awaitable<void> wait()
  {
    if (!svc) {
      ...
      svc = &boost::asio::use_service<ceph::async::service<lease_state>>(
          boost::asio::query(co_await boost::asio::this_coro::executor,
