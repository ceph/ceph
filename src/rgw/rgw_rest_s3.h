...
public:
  ...
  int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jaeger_tracing::Span& parent_span = nullptr) override;
...
public:
  ...
  void send_response_data(bufferlist &bl, const jaeger_tracing::Span& parent_span = nullptr) override;
};
...
{
public:
  void send_response_data(const jaeger_tracing::Span& parent_span = nullptr) override;
};
...
protected:
  ...
  int get_common_params(const jaeger_tracing::Span& parent_span = nullptr);
  void send_common_response(const jaeger_tracing::Span& parent_span = nullptr);
  void send_common_versioned_response(const jaeger_tracing::Span& parent_span = nullptr);
  public:
  ...
  int get_params(const jaeger_tracing::Span& parent_span = nullptr) override;
  void send_response(const jaeger_tracing::Span& parent_span = nullptr) override;
  void send_versioned_response(const jaeger_tracing::Span& parent_span = nullptr);
};
...
public:
  ...
  int get_encrypt_filter(std::unique_ptr<rgw::putobj::DataProcessor> *filter,
                         rgw::putobj::DataProcessor *cb, const jaeger_tracing::Span& parent_span = nullptr) override;
  int get_decrypt_filter(std::unique_ptr<RGWGetObj_Filter>* filter,
                         RGWGetObj_Filter* cb,
                         map<string, bufferlist>& attrs,
                         bufferlist* manifest_bl, const jaeger_tracing::Span& parent_span = nullptr) override;
};
...
public:
  ...
  int init_dest_policy(const jaeger_tracing::Span& parent_span = nullptr) override;
  int get_params(const jaeger_tracing::Span& parent_span = nullptr) override;
...
public:
  ...
  int get_params(const jaeger_tracing::Span& parent_span = nullptr) override;
  void send_response(const jaeger_tracing::Span& parent_span = nullptr) override;
  int prepare_encryption(map<string, bufferlist>& attrs, const jaeger_tracing::Span& parent_span = nullptr) override;
};
...
public:
  ...
  virtual int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jaeger_tracing::Span& parent_span = nullptr) override;

  virtual int get_params(const jaeger_tracing::Span& parent_span = nullptr) override;
