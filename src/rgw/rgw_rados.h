...
class RGWRados
{
  ...
  void remove_rgw_head_obj(R::WriteOp& op);
...
public:
  ...
  protected:
    ...
    int prepare_atomic_modification(R::WriteOp& op, bool reset_obj, const string *ptag,
  ...
  public:
	...
	bc::flat_map<std::string, bufferlist>* rmattrs = nullptr;
