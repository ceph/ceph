...
rgw_http_errors rgw_http_s3_errors({
    ...
    { ERR_USER_NUMBER_QUOTA_EXCEEDED, {403, "UserNumberQuotaExceeded" }},
    { ERR_USER_SIZE_QUOTA_EXCEEDED, {403, "UserSizeQuotaExceeded" }},
    { ERR_BUCKET_NUMBER_QUOTA_EXCEEDED, {403, "BucketNumberQuotaExceeded" }},
    { ERR_BUCKET_SIZE_QUOTA_EXCEEDED, {403, "BucketSizeQuotaExceeded" }},
