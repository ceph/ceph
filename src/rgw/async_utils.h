...
{
  return run_coro(execution_context.get_executor(), std::move(coro), what);
}
...
{
  return run_coro(execution_context.get_executor(), std::move(coro), val, what);
}
...
{
  return run_coro(execution_context.get_executor(), std::move(coro),
		  std::move(vals), what);
}
