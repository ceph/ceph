...
void create_top_metatable(lua_State* L, req_state* s, const char* op_name, const rgw::sal::Object* multi_delete_obj) {
  static const char* request_table_name = "Request";
  create_metatable<RequestMetaTable>(L, "", request_table_name, true, s, const_cast<char*>(op_name), const_cast<rgw::sal::Object*>(multi_delete_obj));
