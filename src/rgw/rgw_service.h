...
class RGWSI_RADOS;
class RGWSI_Zone;
class RGWSI_Zone_RADOS;
class RGWSI_ZoneUtils;
class RGWSI_ZoneUtils_RADOS;
class RGWSI_Quota;
class RGWSI_SyncModules;
class RGWSI_SysObj;
class RGWSI_SysObj_Core;
class RGWSI_SysObj_Cache;
class RGWSI_SysObj_Core_RADOS;
class RGWSI_SysObj_Cache_RADOS;
class RGWSI_User;
...
struct RGWServices_Def
{
  ...
  std::unique_ptr<RGWSI_MDLog_RADOS> mdlog_rados;
  ...
  std::unique_ptr<RGWSI_Zone_RADOS> zone_rados;
  std::unique_ptr<RGWSI_ZoneUtils_RADOS> zone_utils_rados;
  std::unique_ptr<RGWSI_Quota> quota;
  std::unique_ptr<RGWSI_SyncModules> sync_modules;
  std::unique_ptr<RGWSI_SysObj> sysobj;
  std::unique_ptr<RGWSI_SysObj_Core_RADOS> sysobj_core_rados;
  std::unique_ptr<RGWSI_SysObj_Cache_RADOS> sysobj_cache_rados;
