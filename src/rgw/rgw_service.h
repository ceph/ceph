...
struct RGWServices_Def
{
  ...
  int init(CephContext *cct, rgw::sal::RGWRadosStore* store,
	   bool have_cache, bool raw_storage, bool run_sync, optional_yield y, const DoutPrefixProvider *dpp);
  void shutdown();
};
...
struct RGWServices
{
  ...
  int do_init(CephContext *cct, rgw::sal::RGWRadosStore* store, bool have_cache,
	      bool raw_storage, bool run_sync, optional_yield y, const DoutPrefixProvider *dpp);
