...
class RadosStore : public Store {
  ...
  public:
    ...
    virtual void wakeup_data_sync_shards(const rgw_zone_id& source_zone, bc::flat_map<int, bc::flat_set<rgw_data_notify_entry> >& shard_ids) override { rados->wakeup_data_sync_shards(source_zone, shard_ids); }
