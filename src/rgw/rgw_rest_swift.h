...
public:
  ...
  int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void handle_listing_chunk(rgw::sal::RGWBucketList&& buckets, const jaeger_tracing::jspan* const parent_span = nullptr) override;
  ...
  void send_response_data_reversed(rgw::sal::RGWBucketList& buckets, const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  int update_slo_segment_size(rgw_slo_entry& entry, const jaeger_tracing::jspan* const parent_span = nullptr);
