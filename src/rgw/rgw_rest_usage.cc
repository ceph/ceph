...
void RGWOp_Usage_Get::execute(optional_yield y, const jspan* const parent_span) {
...
void RGWOp_Usage_Delete::execute(optional_yield y, const jspan* const parent_span) {
  string uid_str;
  string bucket_name;
  uint64_t start, end;
