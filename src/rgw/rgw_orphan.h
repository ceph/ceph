...
#define RGW_ORPHANSEARCH_HASH_PRIME 7877
  ...
  int handle_stat_result(const DoutPrefixProvider *dpp, map<int, list<string> >& oids, rgw::sal::RGWObject::StatOp::Result& result);
...
class RGWRadosList {
  ...
  int handle_stat_result(const DoutPrefixProvider *dpp,
                         rgw::sal::RGWObject::StatOp::Result& result,
