...
#define RGW_ATTR_CRYPT_BLOCKS     RGW_ATTR_CRYPT_PREFIX "blocks"
#define RGW_ATTR_CRYPT_IV_PREFIX  RGW_ATTR_CRYPT_PREFIX "ivprefix"
#define RGW_ATTR_CRYPT_AUTH_TAG   RGW_ATTR_CRYPT_PREFIX "authtag"
