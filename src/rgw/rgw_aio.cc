...
Aio::OpFunc aio_abstract(librados::IoCtx ctx, Op&& op, const otel_span_context_t& trace_ctx = {false, false}) {
...
template <typename Op>
Aio::OpFunc aio_abstract(librados::IoCtx ctx, Op&& op, optional_yield y, const otel_span_context_t& trace_ctx = {false, false}) {
...
Aio::OpFunc Aio::librados_op(librados::IoCtx ctx,
                             ...
                             optional_yield y, const otel_span_context_t& trace_ctx) {
