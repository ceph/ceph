...
namespace rgw {
			 ...
			 uint32_t flags)
  {
    ...
    RGWGetKeysRequest req(cct, get_user(), rgw_fh->bucket_name(), obj_name,
			  marker);
			  ...
			  uint32_t flags)
  {
    ...
    RGWSetOmapAttrsRequest req(cct, get_user(), rgw_fh->bucket_name(),
			       obj_name);
			 ...
			 uint32_t flags)
  {
    ...
    RGWDelOmapKeysRequest req(cct, get_user(), rgw_fh->bucket_name(), obj_name);
