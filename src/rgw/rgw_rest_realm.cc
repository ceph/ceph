...
void RGWOp_Period_Get::execute(optional_yield y, const jspan* const parent_span)
{
...
void RGWOp_Period_Post::execute(optional_yield y, const jspan* const parent_span)
{
  auto cct = store->ctx();
...
void RGWOp_Realm_Get::execute(optional_yield y, const jspan* const parent_span)
{
  string id;
...
void RGWOp_Realm_List::execute(optional_yield y, const jspan* const parent_span)
{
  {
    // read default realm
