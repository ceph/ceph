...
public:
  ...
  int read_permissions(RGWOp* op_obj, const jaeger_tracing::jspan* const parent_span = nullptr) override {
...
public:
  ...
  int header_init() override {
    ...
    /* XXX required in RGWOp::execute(const jaeger_tracing::jspan* const parent_span) */
  ...
  int get_data(buffer::list& _bl, const jaeger_tracing::jspan* const parent_span = nullptr) override {
...
public:
  ...
  int send_response_data(ceph::buffer::list& bl, off_t bl_off,
                         off_t bl_len, const jaeger_tracing::jspan* const parent_span = nullptr) override {
    size_t bytes;
...
public:
  ...
  int send_response_data(ceph::buffer::list& _bl, off_t s_off,
                         off_t e_off, const jaeger_tracing::jspan* const parent_span = nullptr) override {
    /* NOP */
    /* XXX save attrs? */
    return 0;
  }
...
public:
  ...
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) {
    return 0;
  }
...
public:
  ...
  int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) override { return 0; }
  bool only_bucket() override { return false; }
  void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override {
