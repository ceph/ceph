...
int parse_bucket_commandline_params(std::vector<const char*>& args, int& num_shards, bool& num_shards_specified,
                                    std::string& object_version, uint64_t& min_rewrite_stripe_size,
                                    BIIndexType& bi_index_type, int& verbose, int& warnings_only,
                                    int& bypass_gc, int& check_head_obj_locator, int& remove_bad,
                                    int& delete_child_objects, int& check_objects,
                                    int& inconsistent_index, std::string& format,
                                    uint64_t& min_rewrite_size, uint64_t& max_rewrite_size);
...
int parse_quota_commandline_params(std::vector<const char*>& args, std::string& quota_scope,
                                   bool& have_max_size, int64_t& max_size, bool& have_max_objects,
                                   int64_t& max_objects);
...
int parse_user_commandline_params(std::vector<const char*>& args,
                                  ...
                                  int& purge_data, int& purge_keys, int& max_buckets, bool& max_buckets_specified,
...
int parse_other_commandline_params(std::vector<const char*>& args, std::string& pool_name,
                                   ...
                                   std::string& date, std::string& replica_log_type_str,
                                   ...
                                   int& max_concurrent_ios, uint64_t& orphan_stale_secs,
                                   std::string& job_id);

int parse_common_commandline_params(std::vector<const char*>& args, rgw_user& user_id, int& pretty_format,
                                    std::string& access_key, int& gen_access_key,
                                    std::string& secret_key, int& gen_secret_key,
                                    std::string& metadata_key, std::string& tenant,
