...
void RGWOp_User_List::execute(const jaeger_tracing::jspan* const parent_span)
{
...
void RGWOp_User_Info::execute(const jaeger_tracing::jspan* const parent_span)
{
  RGWUserAdminOpState op_state;
...
void RGWOp_User_Create::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
...
void RGWOp_User_Modify::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string display_name;
  std::string email;
...
void RGWOp_User_Remove::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  bool purge_data;
...
void RGWOp_Subuser_Create::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string subuser;
  std::string secret_key;
...
void RGWOp_Subuser_Modify::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string subuser;
  std::string secret_key;
...
void RGWOp_Subuser_Remove::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string subuser;
  bool purge_keys;
...
void RGWOp_Key_Create::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string subuser;
  std::string access_key;
...
void RGWOp_Key_Remove::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string subuser;
  std::string access_key;
...
void RGWOp_Caps_Add::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string caps;
...
void RGWOp_Caps_Remove::execute(const jaeger_tracing::jspan* const parent_span)
{
  std::string uid_str;
  std::string caps;
...
void RGWOp_Quota_Info::execute(const jaeger_tracing::jspan* const parent_span)
{
  RGWUserAdminOpState op_state;
...
void RGWOp_Quota_Set::execute(const jaeger_tracing::jspan* const parent_span)
{
  RGWUserAdminOpState op_state;
