                                                ...
                                                rgw::sal::Driver* driver)
{
  ...
  // Get supported digest algorithms from the TempURL implementation
  for (const auto& digest_name : rgw::auth::swift::TempURLEngine::get_supported_digest_algorithms()) {
