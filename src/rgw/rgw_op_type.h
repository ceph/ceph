...
enum RGWOpType {
  ...
  RGW_OP_LIST_POLICIES,
  RGW_OP_CREATE_POLICY_VERSION,
  RGW_OP_DELETE_POLICY_VERSION,
  RGW_OP_GET_POLICY_VERSION,
  RGW_OP_SET_DEFAULT_POLICY_VERSION,
  RGW_OP_LIST_POLICY_VERSIONS,
  RGW_OP_TAG_POLICY,
  RGW_OP_UNTAG_POLICY,
  RGW_OP_LIST_POLICY_TAGS,
  RGW_OP_LIST_ENTITIES_FOR_POLICY
};
