...
enum RGWOpType {
  ...
  /* S3 Files API (restJson1) */
  RGW_OP_S3FILES_CREATE_FILE_SYSTEM,
  RGW_OP_S3FILES_GET_FILE_SYSTEM,
  RGW_OP_S3FILES_LIST_FILE_SYSTEMS,
  RGW_OP_S3FILES_DELETE_FILE_SYSTEM,
  RGW_OP_S3FILES_PUT_FILE_SYSTEM_POLICY,
  RGW_OP_S3FILES_GET_FILE_SYSTEM_POLICY,
  RGW_OP_S3FILES_DELETE_FILE_SYSTEM_POLICY,
  RGW_OP_S3FILES_PUT_SYNCHRONIZATION_CONFIGURATION,
  RGW_OP_S3FILES_GET_SYNCHRONIZATION_CONFIGURATION,
  RGW_OP_S3FILES_CREATE_ACCESS_POINT,
  RGW_OP_S3FILES_GET_ACCESS_POINT,
  RGW_OP_S3FILES_LIST_ACCESS_POINTS,
  RGW_OP_S3FILES_DELETE_ACCESS_POINT,
  RGW_OP_S3FILES_CREATE_MOUNT_TARGET,
  RGW_OP_S3FILES_GET_MOUNT_TARGET,
  RGW_OP_S3FILES_LIST_MOUNT_TARGETS,
  RGW_OP_S3FILES_UPDATE_MOUNT_TARGET,
  RGW_OP_S3FILES_DELETE_MOUNT_TARGET,
  RGW_OP_S3FILES_LIST_TAGS_FOR_RESOURCE,
  RGW_OP_S3FILES_TAG_RESOURCE,
  RGW_OP_S3FILES_UNTAG_RESOURCE,
};
