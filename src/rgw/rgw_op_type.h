...
enum RGWOpType {
  ...
  /* s3Vector */
  RGW_OP_S3VECTOR_CREATE_INDEX,
  RGW_OP_S3VECTOR_CREATE_VECTOR_BUCKET,
  RGW_OP_S3VECTOR_DELETE_INDEX,
  RGW_OP_S3VECTOR_DELETE_VECTOR_BUCKET,
  RGW_OP_S3VECTOR_DELETE_VECTOR_BUCKET_POLICY,
  RGW_OP_S3VECTOR_DELETE_VECTORS,
  RGW_OP_S3VECTOR_GET_INDEX,
  RGW_OP_S3VECTOR_GET_INDEX_STATS,
  RGW_OP_S3VECTOR_GET_VECTOR_BUCKET,
  RGW_OP_S3VECTOR_GET_VECTOR_BUCKET_POLICY,
  RGW_OP_S3VECTOR_GET_VECTORS,
  RGW_OP_S3VECTOR_LIST_INDEXES,
  RGW_OP_S3VECTOR_LIST_VECTOR_BUCKETS,
  RGW_OP_S3VECTOR_LIST_VECTORS,
  RGW_OP_S3VECTOR_PUT_VECTOR_BUCKET_POLICY,
  RGW_OP_S3VECTOR_PUT_VECTORS,
  RGW_OP_S3VECTOR_QUERY_VECTORS,
};
