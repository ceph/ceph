...
void RGWOp_ZoneGroupMap_Get::execute(const jaeger_tracing::jspan* const parent_span) {
...
void RGWOp_ZoneGroupMap_Get::send_response(const jaeger_tracing::jspan* const parent_span) {
...
void RGWOp_ZoneConfig_Get::send_response(const jaeger_tracing::jspan* const parent_span) {
