...
public:
  ...
  virtual int list_keys_next(const DoutPrefixProvider *dpp, void *handle, int max, list<string>& keys, bool *truncated);
  virtual int list_keys_next(const DoutPrefixProvider *dpp, void *handle, int max, list<KeyInfo>& keys, bool *truncated) = 0;
...
public:
  ...
  int list_keys_next(const DoutPrefixProvider *dpp, void *handle, int max, list<RGWMetadataHandler::KeyInfo>& keys, bool *truncated);
