 ...
 *
 * All rgw:// URLs will automatically be routed through RGW SAL.
 */
 ...
 */
void rgw_lancedb_store_free_provider(struct LanceDBObjectStoreProvider* provider);
 ...
 */
const char* rgw_lancedb_store_version(void);
