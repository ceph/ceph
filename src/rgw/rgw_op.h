 ...
 * execute(const jaeger_tracing::jspan* const parent_span = nullptr) method that does whatever the subclass name implies.
...
protected:
  ...
  int do_init_permissions(const jaeger_tracing::jspan* const parent_span = nullptr);
  int do_read_permissions(RGWOp* op, bool only_bucket, const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  virtual int init_permissions(RGWOp*, const jaeger_tracing::jspan* const parent_span = nullptr) {
    return 0;
  }
  ...
  virtual int read_permissions(RGWOp* op, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
...
protected:
  ...
  virtual int init_quota(const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  int read_bucket_cors(const jaeger_tracing::jspan* const parent_span = nullptr);
  ...
  virtual bool prefetch_data(const jaeger_tracing::jspan* const parent_span = nullptr) { return false; }
  ...
  virtual int verify_permission(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual int verify_op_mask(const jaeger_tracing::jspan* const parent_span = nullptr);
  virtual void pre_exec(const jaeger_tracing::jspan* const parent_span = nullptr) {}
  virtual void execute(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) {}
  virtual void complete(const jaeger_tracing::jspan* const parent_span = nullptr) {
...
protected:
  ...
  int init_common(const jaeger_tracing::jspan* const parent_span = nullptr);
public:
  RGWGetObj() {
    range_str = NULL;
    if_mod = NULL;
  ...
  bool prefetch_data(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  ...
  int read_user_manifest_part(
    ...
    const off_t end_ofs,
    bool swift_slo, const jaeger_tracing::jspan* const parent_span = nullptr);
  int handle_user_manifest(const char *prefix, const jaeger_tracing::jspan* const parent_span = nullptr);
  int handle_slo_manifest(bufferlist& bl, const jaeger_tracing::jspan* const parent_span = nullptr);

  int get_data_cb(bufferlist& bl, off_t ofs, off_t len, const jaeger_tracing::jspan* const parent_span = nullptr);

  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual int send_response_data_error(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual int send_response_data(bufferlist& bl, off_t ofs, off_t len, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
...
class RGWGetObjTags : public RGWOp {
 ...
 public:
  ...
  virtual void send_response_data(bufferlist& bl, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
...
class RGWPutObjTags : public RGWOp {
 ...
 public:
  ...
  virtual void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override = 0;
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
...
public:
  ...
  virtual void send_response_data(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
...
public:
  ...
  virtual int get_data(std::list<acct_path_t>& items,
                       bool * is_truncated) = 0;
  void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual void handle_listing_chunk(rgw::sal::RGWBucketList&& buckets, const jaeger_tracing::jspan* const parent_span = nullptr) {
  ...
  virtual void send_response_begin(bool has_buckets, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual void send_response_data(rgw::sal::RGWBucketList& buckets, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual void send_response_end(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override {}
...
protected:
  ...
  int parse_max_keys(const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) { return 0; }
...
public:
  ...
  virtual int init_processing(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  ...
  virtual int get_decrypt_filter(std::unique_ptr<RGWGetObj_Filter>* filter,
                                 RGWGetObj_Filter* cb,
                                 map<string, bufferlist>& attrs,
                                 bufferlist* manifest_bl, const jaeger_tracing::jspan* const parent_span = nullptr) {
    *filter = nullptr;
    return 0;
  }
  virtual int get_encrypt_filter(std::unique_ptr<rgw::putobj::DataProcessor> *filter,
                                 rgw::putobj::DataProcessor *cb, const jaeger_tracing::jspan* const parent_span = nullptr) {
    return 0;
  }

  int get_data_cb(bufferlist& bl, off_t bl_ofs, off_t bl_len, const jaeger_tracing::jspan* const parent_span = nullptr);
  int get_data(const off_t fst, const off_t lst, bufferlist& bl, const jaeger_tracing::jspan* const parent_span = nullptr);

  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual int get_data(bufferlist& bl, const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  int init_processing(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  int verify_permission(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void pre_exec(const jaeger_tracing::jspan* const parent_span = nullptr) override { }
  void execute(const jaeger_tracing::jspan* const parent_span = nullptr) override;
...
public:
  ...
  virtual int init_dest_policy(const jaeger_tracing::jspan* const parent_span = nullptr) { return 0; }
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual void send_partial_response(off_t ofs, const jaeger_tracing::jspan* const parent_span = nullptr) {}
  void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  int verify_permission(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void pre_exec(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void execute(const jaeger_tracing::jspan* const parent_span = nullptr) override = 0;
...
public:
  ...
  uint32_t op_mask() override { return RGW_OP_TYPE_WRITE; }
  virtual int prepare_encryption(map<string, bufferlist>& attrs, const jaeger_tracing::jspan* const parent_span = nullptr) { return 0; }
};
...
public:
  ...
  void pre_exec(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void execute(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void complete(const jaeger_tracing::jspan* const parent_span = nullptr) override;
...
extern int rgw_build_bucket_policies(rgw::sal::RGWRadosStore* store, struct req_state* s, const jaeger_tracing::jspan* const parent_span = nullptr);
extern int rgw_build_object_policies(rgw::sal::RGWRadosStore *store, struct req_state *s,
				     bool prefetch_data, const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  void execute(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  int get_params(const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  void pre_exec(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  void execute(const jaeger_tracing::jspan* const parent_span = nullptr) override;
  virtual void send_response(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
  virtual int get_params(const jaeger_tracing::jspan* const parent_span = nullptr) = 0;
