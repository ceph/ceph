...
TESTS_BY_CATEGORY[list-auth]="test_bucket_list_objects_anonymous_fail or test_list_buckets_bad_auth"
...
TESTS_BY_CATEGORY[atomic]="test_atomic_write_1mb or test_atomic_write_4mb or test_atomic_write_8mb or test_atomic_read_1mb or test_atomic_read_4mb or test_atomic_read_8mb or test_atomic_dual_write_1mb or test_atomic_dual_write_4mb or test_atomic_dual_write_8mb or test_atomic_conditional_write_1mb"
...
TESTS_BY_CATEGORY[versioning-concurrent]="test_versioned_concurrent_object_create_and_remove or test_versioned_concurrent_object_create_concurrent_remove"

TESTS_BY_CATEGORY[bucket-policy]="test_bucket_policy or test_bucketv2_policy"
...
--deselect s3tests/functional/test_s3.py::test_bucket_list_delimiter_prefix_underscore \
--deselect s3tests/functional/test_s3.py::test_bucket_listv2_delimiter_prefix_underscore \
