...
struct RGWTable : EmptyMetaTable {
  ...
  static int IndexClosure(lua_State* L) {
    ...
    const auto is_increment = boost::iequals(index, INCREMENT);

    // Lua table fields are matched case-insensitively:
    if (is_increment || boost::iequals(index, DECREMENT)) {
      lua_pushlightuserdata(L, map);
      lua_pushlightuserdata(L, &mtx);
      lua_pushboolean(L, !is_increment /*decrement*/);
  ...
  static int NewIndexClosure(lua_State* L) {
    ...
    // Lua table fields are matched case-insensitively:
    if (boost::iequals(index, INCREMENT) || boost::iequals(index, DECREMENT)) {
