...
int RGWAccessControlList::get_perm(const rgw_user& id, int perm_mask) {
...
int RGWAccessControlPolicy::get_perm(const rgw_user& id,
                                     const int perm_mask,
...
bool RGWAccessControlPolicy::verify_permission(const rgw_user& uid,
