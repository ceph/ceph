...
{{ "s3:AbortMultipartUpload", s3AbortMultipartUpload },
 ...
 { "s3:GetBucketDedupPolicy", s3GetBucketDedupPolicy },
 ...
 { "s3:PutBucketDedupPolicy", s3PutBucketDedupPolicy },
...
const char* action_bit_string(uint64_t action) {
  ...
  case s3GetBucketDedupPolicy:
    return "s3:GetBucketDedupPolicy";

  case s3PutBucketDedupPolicy:
    return "s3:PutBucketDedupPolicy";
