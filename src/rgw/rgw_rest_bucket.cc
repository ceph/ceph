...
void RGWOp_Bucket_Info::execute(optional_yield y, const jspan* const parent_span)
{
...
void RGWOp_Get_Policy::execute(optional_yield y, const jspan* const parent_span)
{
  RGWBucketAdminOpState op_state;
...
void RGWOp_Check_Bucket_Index::execute(optional_yield y, const jspan* const parent_span)
{
  std::string bucket;
...
void RGWOp_Bucket_Link::execute(optional_yield y, const jspan* const parent_span)
{
  std::string uid_str;
  std::string bucket;
...
void RGWOp_Bucket_Unlink::execute(optional_yield y, const jspan* const parent_span)
{
  std::string uid_str;
  std::string bucket;
...
void RGWOp_Bucket_Remove::execute(optional_yield y, const jspan* const parent_span)
{
...
void RGWOp_Set_Bucket_Quota::execute(optional_yield y, const jspan* const parent_span)
{
...
void RGWOp_Sync_Bucket::execute(optional_yield y, const jspan* const parent_span)
{
  std::string bucket;
  std::string tenant;
  bool sync_bucket;
...
void RGWOp_Object_Remove::execute(optional_yield y, const jspan* const parent_span)
{
  std::string bucket;
  std::string object;
