...
namespace rgw::flight {
  ...
  struct FlightData {
    ...
    FlightData& operator=(const FlightData&) = default;
  ...
  public:
    ...
    FlightStore(boost::intrusive_ptr<ceph::common::CephContext>& _cct);
    virtual ~FlightStore();
  ...
  public:
    ...
    MemoryFlightStore(boost::intrusive_ptr<ceph::common::CephContext>& _cct);
