...
public:
  ...
  int get_params(const jaeger_tracing::Span& parent_span = nullptr) override;
  int get_data(bufferlist& bl, const jaeger_tracing::Span& parent_span = nullptr) override;
};
...
public:
  ...
  int init_permissions(RGWOp* op, const jaeger_tracing::Span& parent_span = nullptr) override;
