...
class MotrNotificationConfig : public StoreNotificationConfig {
  MotrStore* store;
  std::string oid;

  public:
    MotrNotificationConfig(MotrStore* _store, const std::string& tenant, const std::string& _oid) :
	  StoreNotificationConfig(tenant), store(_store), oid(_oid) {}
    ~MotrNotificationConfig() = default;
