...
void add_rgw_op_counters(PerfCountersBuilder *lpcb) {
  ...
  lpcb->add_u64_counter(l_rgw_op_put_obj_b, "put_obj_bytes", "Size of puts", "", PerfCountersBuilder::PRIO_CRITICAL, PerfCountersBuilder::UNIT_BYTES);
  ...
  lpcb->add_u64_counter(l_rgw_op_get_obj_b, "get_obj_bytes", "Size of gets", "", PerfCountersBuilder::PRIO_CRITICAL, PerfCountersBuilder::UNIT_BYTES);
  ...
  lpcb->add_u64_counter(l_rgw_op_del_obj_b, "del_obj_bytes", "Size of delete objects", "", PerfCountersBuilder::PRIO_CRITICAL, PerfCountersBuilder::UNIT_BYTES);
  ...
  lpcb->add_u64_counter(l_rgw_op_copy_obj_b, "copy_obj_bytes", "Size of copy objects", "", PerfCountersBuilder::PRIO_CRITICAL, PerfCountersBuilder::UNIT_BYTES);
