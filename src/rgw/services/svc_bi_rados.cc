...
int RGWSI_BucketIndex_RADOS::open_bucket_index_pool(const RGWBucketInfo& bucket_info,
                                                    RGWSI_RADOS::Pool *index_pool, const jaeger_tracing::jspan* const parent_span)
{
...
int RGWSI_BucketIndex_RADOS::open_bucket_index(const RGWBucketInfo& bucket_info,
                                               ...
                                               map<int, string> *bucket_instance_ids, const jaeger_tracing::jspan* const parent_span)
{
  string bucket_oid_base;
  [[maybe_unused]] const auto span_1 = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
...
int RGWSI_BucketIndex_RADOS::init_index(RGWBucketInfo& bucket_info, const jaeger_tracing::jspan* const parent_span)
{
  string bucket_oid_base;
  [[maybe_unused]] const auto span_1 = jaeger_tracing::child_span(__PRETTY_FUNCTION__, parent_span);
