...
private:
  int open_pool_ctx(const rgw_pool& pool, librados::IoCtx& io_ctx,
                    const OpenParams& params = {}, const jaeger_tracing::jspan* const parent_span = nullptr);
...
public:
  ...
  public:
    ...
    int lookup();
    int open(const OpenParams& params = {}, const jaeger_tracing::jspan* const parent_span = nullptr);
