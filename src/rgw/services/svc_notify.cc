...
bs::error_code RGWSI_Notify::init_watch()
{
...
bs::error_code
RGWSI_Notify::robust_notify(neo_obj_ref& notify_obj, bufferlist& bl,
                            optional_yield y)
{
