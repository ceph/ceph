...
int RGWSI_RADOS::open_pool_ctx(const rgw_pool& pool, librados::IoCtx& io_ctx,
                               const OpenParams& params, const jaeger_tracing::jspan* const parent_span)
{
...
int RGWSI_RADOS::Pool::open(const OpenParams& params, const jaeger_tracing::jspan* const parent_span)
{
