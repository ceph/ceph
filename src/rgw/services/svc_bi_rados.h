...
class RGWSI_BucketIndex_RADOS : public RGWSI_BucketIndex
{
  ...
  int open_pool(const rgw_pool& pool,
                ...
                bool mostly_omap, const jaeger_tracing::Span& parent_span = nullptr);

  int open_bucket_index_pool(const RGWBucketInfo& bucket_info,
                            RGWSI_RADOS::Pool *index_pool, const jaeger_tracing::Span& parent_span = nullptr);
...
public:
  ...
  int init_index(RGWBucketInfo& bucket_info, const jaeger_tracing::Span& parent_span = nullptr);
  ...
  int open_bucket_index(const RGWBucketInfo& bucket_info,
                        ...
                        map<int, string> *bucket_instance_ids, const jaeger_tracing::Span& parent_span = nullptr);
};
