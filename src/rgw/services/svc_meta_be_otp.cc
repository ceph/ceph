                                     ...
                                     RGWObjVersionTracker *objv_tracker)
{
  ...
  int r = cls_svc->mfa.list_mfa(key, params.pdevices, objv_tracker, params.pmtime, null_yield);
  if (r < 0) {
    return r;
  }
                                     ...
                                     RGWObjVersionTracker *objv_tracker)
{
  ...
  return cls_svc->mfa.set_mfa(key, params.devices, true, objv_tracker, params.mtime, null_yield);
}
