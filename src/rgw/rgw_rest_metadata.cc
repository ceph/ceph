...
void RGWOp_Metadata_Get::execute(const jaeger_tracing::jspan* const parent_span) {
  string metadata_key;
...
void RGWOp_Metadata_Get_Myself::execute(const jaeger_tracing::jspan* const parent_span) {
  string owner_id;
...
void RGWOp_Metadata_List::execute(const jaeger_tracing::jspan* const parent_span) {
  string marker;
...
void RGWOp_Metadata_Put::execute(const jaeger_tracing::jspan* const parent_span) {
  bufferlist bl;
  string metadata_key;
...
void RGWOp_Metadata_Put::send_response(const jaeger_tracing::jspan* const parent_span) {
...
void RGWOp_Metadata_Delete::execute(const jaeger_tracing::jspan* const parent_span) {
  string metadata_key;
