...
void RGWOp_Metadata_Get::execute(optional_yield y, const jspan* const parent_span) {
  string metadata_key;
...
void RGWOp_Metadata_Get_Myself::execute(optional_yield y, const jspan* const parent_span) {
  string owner_id;
...
void RGWOp_Metadata_List::execute(optional_yield y, const jspan* const parent_span) {
  string marker;
...
void RGWOp_Metadata_Put::execute(optional_yield y, const jspan* const parent_span) {
  bufferlist bl;
  string metadata_key;
...
void RGWOp_Metadata_Delete::execute(optional_yield y, const jspan* const parent_span) {
  string metadata_key;
