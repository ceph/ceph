...
class AsioFrontend {
  ...
  void accept(Listener& listener, spawn::yield_context yield);
...
// Setting global timeout
  ...
  for (auto& l : listeners) {
    ...
    boost::asio::spawn(context,
      [this, &l] (spawn::yield_context yield) mutable {
        accept(l, yield);
...
void AsioFrontend::accept(Listener& l, spawn::yield_context yield)
{
  for (;;) {
    boost::system::error_code ec;
