...
bool is_non_s3_op(RGWOpType op_type)
{
  ...
  case RGW_OP_S3FILES_CREATE_FILE_SYSTEM:
  case RGW_OP_S3FILES_GET_FILE_SYSTEM:
  case RGW_OP_S3FILES_LIST_FILE_SYSTEMS:
  case RGW_OP_S3FILES_DELETE_FILE_SYSTEM:
  case RGW_OP_S3FILES_PUT_FILE_SYSTEM_POLICY:
  case RGW_OP_S3FILES_GET_FILE_SYSTEM_POLICY:
  case RGW_OP_S3FILES_DELETE_FILE_SYSTEM_POLICY:
  case RGW_OP_S3FILES_PUT_SYNCHRONIZATION_CONFIGURATION:
  case RGW_OP_S3FILES_GET_SYNCHRONIZATION_CONFIGURATION:
  case RGW_OP_S3FILES_CREATE_ACCESS_POINT:
  case RGW_OP_S3FILES_GET_ACCESS_POINT:
  case RGW_OP_S3FILES_LIST_ACCESS_POINTS:
  case RGW_OP_S3FILES_DELETE_ACCESS_POINT:
  case RGW_OP_S3FILES_CREATE_MOUNT_TARGET:
  case RGW_OP_S3FILES_GET_MOUNT_TARGET:
  case RGW_OP_S3FILES_LIST_MOUNT_TARGETS:
  case RGW_OP_S3FILES_UPDATE_MOUNT_TARGET:
  case RGW_OP_S3FILES_DELETE_MOUNT_TARGET:
  case RGW_OP_S3FILES_LIST_TAGS_FOR_RESOURCE:
  case RGW_OP_S3FILES_TAG_RESOURCE:
  case RGW_OP_S3FILES_UNTAG_RESOURCE:
    return true;
  default:
    return false;
  }
