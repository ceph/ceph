...
public:
  ...
  void print(std::ostream& out) const override {
    ...
    if (is_dirfrag_dirty()) out << " dirty_dirfrag";
    out << ")";
  }
  ...
  bool is_dirfrag_dirty() const {
    return flags & FLAG_DIRTY_DIRFRAG;
  }
...
protected:
  ...
  MMDSScrub(int o, inodeno_t i, fragset_t&& _frags, std::string_view _tag,
    ...
    if (dirfrag_dirty) flags |= FLAG_DIRTY_DIRFRAG;
  }
...
private:
  ...
  static constexpr unsigned FLAG_DIRTY_DIRFRAG	= 1<<4;
