...
class MDiscover : public MessageInstanceSafe<MDiscover> {
public:
  friend factory;
private:
...
protected:
  MDiscover() : MessageInstanceSafe<MDiscover>(MSG_MDS_DISCOVER) { }
  MDiscover(inodeno_t base_ino_,
    ...
    MessageInstanceSafe<MDiscover>(MSG_MDS_DISCOVER),
    base_ino(base_ino_),
