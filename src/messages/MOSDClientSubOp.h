...
#ifndef CEPH_MOSDCLIENTSUBOP_H
#define CEPH_MOSDCLIENTSUBOP_H
...
class MOSDClientSubOp : public Message {
...
public:
  ...
  MOSDClientSubOp(osd_reqid_t r, pg_shard_t from,
...
public:
  const char *get_type_name() const { return "osd_client_sub_op"; }
  void print(ostream& out) const {
    out << "osd_client_sub_op(" << reqid
	<< " " << pgid
	<< " " << poid;
    out << " v " << version;
