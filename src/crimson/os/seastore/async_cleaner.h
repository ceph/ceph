...
private:
  ...
  journal_seq_t get_trim_dirty_target() const;
  ...
  std::size_t get_dirty_bytes_to_trim() const {
    std::size_t journal_dirty_bytes = get_journal_dirty_bytes();
    return std::min(journal_dirty_bytes - config.min_journal_bytes,
