...
public:
   ...
   *
   * @param root   (unused here) OMAP root the higher layer passed in.
   * @param onode  Onode 
   * @param t      Transaction context
   * @param _kvs   Batch of keys to set
   */
  omap_set_keys_ret omap_set_keys(omap_root_t &omap_root, Onode &onode,
   ...
   */
  omap_get_value_ret
  omap_get_value(const omap_root_t &omap_root, Onode &onode, Transaction &t,
   ...
   *
   * @param root      (unused here) logical OMAP root the higher layer passed in.
   * @param onode      Onode 
   * @param t          Transaction context 
   *
   */
  omap_clear_ret omap_clear(omap_root_t &omap_root,
   ...
   *
   */
  omap_set_key_ret _log_set_key(omap_root_t &omap_root,
