...
public:
  ...
  void rewrite(CachedExtent &e, extent_len_t o, Transaction &t) {
   ...
   *
   */
  virtual void on_rewrite(CachedExtent &, extent_len_t, Transaction &) = 0;
...
public:
  ...
  virtual PhysicalNodeMappingRef<key_t, val_t> refresh() {
...
public:
  ...
  void on_rewrite(CachedExtent&, extent_len_t, Transaction &t) final {}
...
public:
  ...
  void on_rewrite(CachedExtent &extent, extent_len_t off, Transaction&) final {
