...
public:
  explicit DumpHistoricOpsHook(const crimson::osd::OperationRegistry& op_registry) :
...
template std::unique_ptr<AdminSocketHook>
make_asok_hook<DumpHistoricOpsHook>(const crimson::osd::OperationRegistry& op_registry);
