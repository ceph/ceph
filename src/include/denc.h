...
inline typename std::enable_if<(bool)traits::supported &&
...
struct denc_traits<
  std::pair<A, B>,
  typename std::enable_if<(bool)denc_traits<A>::supported &&
			  (bool)denc_traits<B>::supported>::type> {
...
struct denc_traits<
  std::list<T>,
  typename std::enable_if<(bool)denc_traits<T>::supported>::type> {
