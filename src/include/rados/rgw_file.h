...
int rgw_lookup(struct rgw_fs *rgw_fs,
	      ...
	      struct stat *st, uint32_t mask, uint32_t flags, bool null_vid);
...
int rgw_mkdir(struct rgw_fs *rgw_fs,
	      struct rgw_file_handle *parent_fh,
	      const char *name, struct stat *st, uint32_t mask,
	      struct rgw_file_handle **fh, uint32_t flags, bool null_vid);
...
int rgw_writev(struct rgw_fs *rgw_fs,
	       struct rgw_file_handle *fh, rgw_uio *uio, uint32_t flags, bool null_vid);
...
int rgw_setxattrs(struct rgw_fs *rgw_fs, struct rgw_file_handle *fh,
		 rgw_xattrlist *attrs, uint32_t flags, bool null_vid);
