...
#define CEPH_MSG_HEADER_FLAGS_COMPRESS_FRONT  (1<<0)
#define CEPH_MSG_HEADER_FLAGS_COMPRESS_MIDDLE (1<<1)
#define CEPH_MSG_HEADER_FLAGS_COMPRESS_DATA   (1<<2)
#define CEPH_MSG_HEADER_FLAGS_COMPRESS_ALL  \
    CEPH_MSG_HEADER_FLAGS_COMPRESS_FRONT  | \
    CEPH_MSG_HEADER_FLAGS_COMPRESS_MIDDLE | \
    CEPH_MSG_HEADER_FLAGS_COMPRESS_DATA
