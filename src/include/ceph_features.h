...
DEFINE_CEPH_FEATURE_DEPRECATED( 0, 1, UID, NAUTILUS)
DEFINE_CEPH_FEATURE( 1, 1, NOSRCADDR)
DEFINE_CEPH_FEATURE_RETIRED( 2, 1, MONCLOCKCHECK, JEWEL, LUMINOUS)
DEFINE_CEPH_FEATURE( 2, 3, SERVER_NAUTILUS)
DEFINE_CEPH_FEATURE( 3, 1, FLOCK)         // v2.6.35-32-gc6f3fdc592d6
DEFINE_CEPH_FEATURE( 4, 1, SUBSCRIBE2)    // v4.5-8493-g82dcabad750a
DEFINE_CEPH_FEATURE( 5, 1, MONNAMES)      // not in kernel
DEFINE_CEPH_FEATURE( 6, 1, RECONNECT_SEQ) // v3.9-67-g3a23083bda56
DEFINE_CEPH_FEATURE( 7, 1, DIRLAYOUTHASH) // v2.6.37-2-g14303d20f3ae
DEFINE_CEPH_FEATURE_DEPRECATED( 8, 1, OBJECTLOCATOR, NAUTILUS) // CLIENT SIDE.  never in kernel.
DEFINE_CEPH_FEATURE( 9, 1, PGID64)        // v3.8-142-g4f6a7e5ee139
DEFINE_CEPH_FEATURE(10, 1, INCSUBOSDMAP)  // not in kernel
DEFINE_CEPH_FEATURE(11, 1, PGPOOL3)       // v3.8-142-g4f6a7e5ee139
DEFINE_CEPH_FEATURE(12, 1, OSDREPLYMUX)   // not in kernel
DEFINE_CEPH_FEATURE(13, 1, OSDENC)        // v3.8-142-g4f6a7e5ee139
DEFINE_CEPH_FEATURE_RETIRED(14, 1, OMAP, HAMMER, JEWEL)
DEFINE_CEPH_FEATURE(14, 2, SERVER_KRAKEN)
DEFINE_CEPH_FEATURE(15, 1, MONENC)        // not in kernel
...
DEFINE_CEPH_FEATURE(18, 1, CRUSH_TUNABLES) // v3.5-rc1-77-g546f04ef716d
