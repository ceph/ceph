...
CEPH_RBD_API int rbd_mirror_group_status_list(
    rados_ioctx_t io_ctx, const char *start_id, size_t max, char **group_ids,
    rbd_mirror_group_status_t *groups, size_t *len);
CEPH_RBD_API void rbd_mirror_group_status_list_cleanup(
    char **group_ids, rbd_mirror_group_status_t *groups, size_t len);
...
CEPH_RBD_API int rbd_mirror_group_get_status(
    rados_ioctx_t p, const char *name,
    rbd_mirror_group_status_t *mirror_group_status, size_t status_size);
CEPH_RBD_API void rbd_mirror_group_status_cleanup(
    rbd_mirror_group_status_t *mirror_group_status);
