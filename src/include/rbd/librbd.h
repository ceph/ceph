...
CEPH_RBD_API ssize_t rbd_writesame2(rbd_image_t image, uint64_t off, size_t write_len,
...
CEPH_RBD_API int rbd_aio_writesame2(rbd_image_t image, uint64_t off, size_t write_len,
                                   const char *buf, size_t data_len, rbd_completion_t c, int op_flags);
