...
public:
  ...
  int mirror_group_status_list(
      IoCtx& io_ctx, const std::string &start_id, size_t max,
      std::map<std::string, mirror_group_status_t> *groups);
  ...
  int group_remove(IoCtx& io_ctx, const char *group_name, uint32_t flags);
  ...
  int mirror_group_get_status(IoCtx& io_ctx, const char *group_name,
                              mirror_group_status_t *mirror_group_status,
                              size_t status_size);
