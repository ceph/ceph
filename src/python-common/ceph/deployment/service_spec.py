...
class ServiceSpec(object):
    ...
    def __init__(self,
        ...
        if self.termination_grace_period_seconds is not None and self.termination_grace_period_seconds < 0:
            raise SpecValidationError('termination_grace_period_seconds must be >= 0')
