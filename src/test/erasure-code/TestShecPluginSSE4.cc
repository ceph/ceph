...
class ErasureCodePluginShecSse4 : public ErasureCodePlugin {
public:

  ErasureCodePluginShecSse4(CephContext* cct) : ErasureCodePlugin(cct)
  {}
                                  ...
                                  const std::string& name)
{
  ...
  return instance->add(type, name, new ErasureCodePluginShecSse4(cct));
}
