...
class ErasureCodePluginNeon : public ErasureCodePlugin {
public:

  ErasureCodePluginNeon(CephContext* cct) : ErasureCodePlugin(cct)
  {}
                                  ...
                                  const std::string& name)
{
  ...
  return instance->add(type, name, new ErasureCodePluginNeon(cct));
}
