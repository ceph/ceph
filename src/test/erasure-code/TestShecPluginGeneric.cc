...
class ErasureCodePluginShecGeneric : public ErasureCodePlugin {
public:

  ErasureCodePluginShecGeneric(CephContext* cct) : ErasureCodePlugin(cct)
  {}
                                  ...
                                  const std::string& name)
{
  ...
  return instance->add(type, name, new ErasureCodePluginShecGeneric(cct));
}
