...
class ErasureCodePluginSse4 : public ErasureCodePlugin {
public:

  ErasureCodePluginSse4(CephContext* cct) : ErasureCodePlugin(cct)
  {}
                                  ...
                                  const std::string& name)
{
  ...
  return instance->add(type, name, new ErasureCodePluginSse4(cct));
}
