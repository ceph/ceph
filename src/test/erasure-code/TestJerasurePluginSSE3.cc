...
class ErasureCodePluginSse3 : public ErasureCodePlugin {
public:

  ErasureCodePluginSse3(CephContext* cct) : ErasureCodePlugin(cct)
  {}
                                  ...
                                  const std::string& name)
{
  ...
  return instance->add(type, name, new ErasureCodePluginSse3(cct));
}
