...
/**
 * MockErasureCode - A mock implementation of ErasureCodeInterface for testing
 * 
 * This class provides a minimal implementation of the ErasureCodeInterface
 * for testing purposes. It can be used by various test suites that need
 * a simple erasure code implementation without the complexity of real
 * erasure code algorithms.
 * 
 * Key features:
 * - Configurable data_chunk_count and chunk_count
 * - Supports all required ErasureCodeInterface methods
 * - Uses ADD_FAILURE() for deprecated methods to catch incorrect usage
 * - Provides basic validation in decode_chunks
 */
