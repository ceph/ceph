...
// libstdc++ 12 does not correctly expose its std::string SSO representation
// to Clang during constant evaluation:
#if !defined(__clang__) || !defined(_GLIBCXX_RELEASE) || 13 <= _GLIBCXX_RELEASE
