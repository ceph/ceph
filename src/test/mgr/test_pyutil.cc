...
{
  PyObject* float_obj = get_python_typed_option_value(Option::TYPE_FLOAT, "11.22");
...
{
  PyObject* bool_obj_true = get_python_typed_option_value(Option::TYPE_BOOL, "true");
  ASSERT_EQ(bool_obj_true, Py_True);
  Py_DECREF(bool_obj_true);

  PyObject* bool_obj_false = get_python_typed_option_value(Option::TYPE_BOOL, "false");
...
{
  PyObject* bool_obj_false = get_python_typed_option_value(Option::TYPE_BOOL, "maybe");
  ASSERT_EQ(bool_obj_false, Py_False);
  Py_DECREF(bool_obj_false);
}
...
{
  PyObject* int_obj_max = get_python_typed_option_value(Option::TYPE_INT, "2147483647");
  ASSERT_TRUE(PyLong_Check(int_obj_max));
  EXPECT_EQ(PyLong_AsLong(int_obj_max), 2147483647);
  Py_DECREF(int_obj_max);

  PyObject* int_obj_min = get_python_typed_option_value(Option::TYPE_INT, "-2147483648");
