...
const char *parse_good[] = {
  ...
  "allow squash_root r",
  "allow rw",
  "allow squash_root rw",
  "allow squash_root rw",
  "allow squash_root rw uid=1",
  "allow squash_root rw path=\"/foo\" uid=1",
  0
};
...
TEST(MDSAuthCaps, OutputParsed) {
  ...
  CapsTest test_values[] = {
    ...
    {"allow r",
     "MDSAuthCaps[allow r]"},
    {"allow squash_root r",
     "MDSAuthCaps[allow squash_root r]"},
    {"allow rw",
     "MDSAuthCaps[allow rw]"},
    {"allow squash_root rw",
     "MDSAuthCaps[allow squash_root rw]"},
    {"allow * uid=1",
