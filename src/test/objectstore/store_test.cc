...
TEST_P(StoreTest, BluestoreOnOffCSumTest) {
  ...
  }
  {
    ...
    ObjectStore::Transaction t2;
    t2.write(cid, hoid, block_size*2, bl.length(), bl, 0, ObjectStore::Transaction::write_params_t());
  ...
  }
  {
    ...
    t2.write(cid, hoid, 0, bl.length(), bl, 0, ObjectStore::Transaction::write_params_t());
    t2.write(cid, hoid, block_size0, bl.length(), bl, 0, ObjectStore::Transaction::write_params_t());
    ...
    t3.write(cid, hoid, block_size0, bl.length(), bl, 0, ObjectStore::Transaction::write_params_t());
