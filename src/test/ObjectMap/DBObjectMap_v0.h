...
#ifndef DBOBJECTMAPV0_DB_H
#define DBOBJECTMAPV0_DB_H
...
/**
 * DBObjectMapv0: Implements ObjectMap in terms of KeyValueDB
 *
 ...
 */
class DBObjectMapv0 : public ObjectMap {
public:
  ...
  DBObjectMapv0(KeyValueDB *db) : db(db), next_seq(1),
...
private:
  ...
  /// Iterator
  class DBObjectMapv0IteratorImpl : public ObjectMapIteratorImpl {
  public:
    DBObjectMapv0 *map;
    ...
    std::tr1::shared_ptr<DBObjectMapv0IteratorImpl> parent_iter;
    ...
    DBObjectMapv0IteratorImpl(DBObjectMapv0 *map, Header header) :
  ...
  typedef std::tr1::shared_ptr<DBObjectMapv0IteratorImpl> DBObjectMapv0Iterator;
  DBObjectMapv0Iterator _get_iterator(Header header) {
    return DBObjectMapv0Iterator(new DBObjectMapv0IteratorImpl(this, header));
  }
   ...
   *
   * Has the side effect of syncronously saving the new DBObjectMapv0 state
   */
  ...
  int need_parent(DBObjectMapv0Iterator iter);
  ...
  public:
    DBObjectMapv0 *db;
    uint64_t seq;
    RemoveOnDelete(DBObjectMapv0 *db) :
      db(db), seq(seq) {}
...
WRITE_CLASS_ENCODER(DBObjectMapv0::_Header)
WRITE_CLASS_ENCODER(DBObjectMapv0::State)
