...
{
  run_scl([this]() -> seastar::future<> {
    auto fut = scl([this]() -> ertr::future<int> {
...
{
  run_ertr_scl([this]() -> ertr::future<int> {
    constexpr int CHECK = 20;
...
TEST_F(coroutine_test_t, interruptible_coroutine_basic)
{
  run_scl([this]() -> seastar::future<> {
    ...
    auto ret = cwi(
      [](auto) { return 2; },
      [this, f=p.get_future()]() mutable -> interruptor::future<int> {
...
TEST_F(coroutine_test_t, dual_interruptible_coroutine)
{
  run_scl([this]() -> seastar::future<> {
    ...
    auto fut2 = cwi(
      [](auto) { return 2; },
      [this, &p2, f=p.get_future()]() mutable -> interruptor::future<int> {
	p2.set_value(0);
	auto x = co_await interruptor::make_interruptible(std::move(f));
	co_return x;
      });
