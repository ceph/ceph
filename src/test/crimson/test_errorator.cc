...
/*
TEST_F(errorator_test_t, assert_all)
{
  run_async([&res, this] {
...
*/
// CAUTION: ignoring a future that carries an abort expection won't
//          cause an abort - instead we get:
//          "seastar - Exceptional future ignored crimson::unthrowable_wrapper"
/*
TEST_F(errorator_test_t, ignore_assert_all)
{
  run_async([this] {
