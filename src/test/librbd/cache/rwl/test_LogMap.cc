...
void register_test_rwl_write_log_map() {
}
...
struct TestLogEntry {
  ...
  uint64_t get_offset_bytes() const { return image_offset_bytes; }
  uint64_t get_write_bytes() const { return write_bytes; }
  BlockExtent block_extent() const {
