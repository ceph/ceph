...
TEST_F(TestGroup, group_create)
{
  ...
  ASSERT_EQ(0, rbd_group_remove(ioctx, "mygroup", 0));
...
TEST_F(TestGroup, group_createPP)
{
  ...
  ASSERT_EQ(0, rbd.group_remove(ioctx, "newgroup", 0));
...
TEST_F(TestGroup, add_image)
{
  ...
  ASSERT_EQ(0, rbd_group_remove(ioctx, group_name, 0));
}
...
TEST_F(TestGroup, add_imagePP)
{
  ...
  ASSERT_EQ(0, rbd.group_remove(ioctx, group_name, 0));
}
...
TEST_F(TestGroup, mirrorPP)
{
  ...
  ASSERT_EQ(0, m_rbd.group_remove(m_ioctx, group_name, 0));
}
