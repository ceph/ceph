...
#include "compressor/CompressorRegistry.h"
...
TEST(CompressorRegistry, con_modes)
{
  ...
  method = reg.pick_method(CEPH_ENTITY_TYPE_MON, Compressor::COMP_FORCE, both_methods);
  ...
  method = reg.pick_method(CEPH_ENTITY_TYPE_OSD, Compressor::COMP_FORCE, both_methods);
  ...
  method = reg.pick_method(CEPH_ENTITY_TYPE_OSD, Compressor::COMP_NONE, both_methods);
  ASSERT_EQ(method, Compressor::COMP_ALG_NONE);

  method = reg.pick_method(CEPH_ENTITY_TYPE_OSD, Compressor::COMP_FORCE, zlib_method);
  ASSERT_EQ(method, Compressor::COMP_ALG_NONE);
