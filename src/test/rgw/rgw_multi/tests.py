    ...
    for zonegroup in realm.current_period.zonegroups:
        ...
        for zg in realm.current_period.zonegroups:
            ...
            if zg.name == zonegroup.name:
                ...
                bucket = z.s3_client.create_bucket(Bucket=gen_bucket_name(), CreateBucketConfiguration={'LocationConstraint': zg.name})
                # check bucket location
                response = z.s3_client.get_bucket_location(Bucket=bucket.name)
