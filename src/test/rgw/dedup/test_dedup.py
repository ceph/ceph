...
class Dedup_Stats:
    ...
    blake3_mismatch: int = 0
    valid_blake3: int = 0
    invalid_blake3: int = 0
    set_blake3: int = 0
...
def calc_expected_stats(dedup_stats, obj_size, num_copies, config):
    ...
    if num_copies == 1:
        ...
        dedup_stats.set_blake3 += num_copies
        dedup_stats.invalid_blake3 += num_copies
...
def reset_full_dedup_stats(dedup_stats):
    ...
    dedup_stats.blake3_mismatch = 0
    dedup_stats.valid_blake3 = 0
    dedup_stats.invalid_blake3 = 0
    dedup_stats.set_blake3 = 0
...
def read_full_dedup_stats(dedup_stats, md5_stats):
    ...
    dedup_stats.valid_blake3 = notify['Valid BLAKE3 attrs']
    dedup_stats.invalid_blake3 = notify['Invalid BLAKE3 attrs']
    key='Set BLAKE3'
    if key in notify:
        dedup_stats.set_blake3 = notify[key]
    ...
    if key in log_failures:
        dedup_stats.blake3_mismatch = log_failures[key]
...
def exec_dedup(expected_dedup_stats, dry_run, verify_stats=True):
    ...
    #dedup_stats.set_blake3 = dedup_stats.invalid_blake3
...
def test_dedup_etag_corruption():
    ...
    try:
        ...
        for corruption in CORRUPTIONS:
            ...
            if corruption == "no corruption":
                expected_dedup_stats.valid_blake3=1
                expected_dedup_stats.invalid_blake3=0
                expected_dedup_stats.set_blake3=0
...
def test_md5_collisions():
    ...
    try:
        ...
        # BLAKE3 check will expose the problem
        dedup_stats.invalid_blake3=dedup_stats.total_processed_objects
        dedup_stats.set_blake3=dedup_stats.total_processed_objects
        dedup_stats.blake3_mismatch=1
        ...
        dedup_stats.valid_blake3=dedup_stats.total_processed_objects
        dedup_stats.invalid_blake3=0
        dedup_stats.set_blake3=0
...
def test_dedup_inc_0_with_tenants():
    ...
    try:
        ...
        dedup_stats2.valid_blake3=dedup_stats.invalid_blake3
        dedup_stats2.invalid_blake3=0
        dedup_stats2.set_blake3=0
...
def test_dedup_inc_1_with_tenants():
    ...
    try:
        ...
        stats_combined.valid_blake3    = stats_base.set_blake3
        stats_combined.invalid_blake3 -= stats_base.set_blake3
        stats_combined.set_blake3     -= stats_base.set_blake3
...
def test_dedup_inc_with_remove_multi_tenants():
    ...
    try:
        ...
        dedup_stats.valid_blake3=valid_hash
        dedup_stats.invalid_blake3=0
        dedup_stats.set_blake3=0
...
def test_dedup_inc_loop_with_tenants():
    ...
    try:
        ...
        for idx in range(0, 9):
            ...
            stats_base.set_blake3          += stats_last.set_blake3
    finally:
        # cleanup must be executed even after a failure
        cleanup_all_buckets(bucket_names, conns)
