...
class Monitoring(ContainerDaemonForm):
    ...
    components = {
        'prometheus': {
            'image': DefaultImages.PROMETHEUS.value.name,
            'cpus': '2',
            'memory': '4GB',
            'args': [
        ...
        'loki': {
            'image': DefaultImages.LOKI.value.name,
            'cpus': '1',
            'memory': '1GB',
            'args': [
        ...
        'promtail': {
            'image': DefaultImages.PROMTAIL.value.name,
            'cpus': '1',
            'memory': '1GB',
            'args': [
        ...
        'node-exporter': {
            'image': DefaultImages.NODE_EXPORTER.value.name,
            'cpus': '1',
            'memory': '1GB',
            'args': ['--no-collector.timex'],
        },
        'grafana': {
            'image': DefaultImages.GRAFANA.value.name,
            'cpus': '2',
            'memory': '4GB',
            'args': [],
            'config-json-files': [
        ...
        'alertmanager': {
            'image': DefaultImages.ALERT_MANAGER.value.name,
            'cpus': '2',
            'memory': '2GB',
            'args': [
