...
def get_mgr_images() -> dict:
    ...
    mgr_images = {}
    mgr_images[
        mgr_prefix + 'prometheus'
    ] = default_images.DEFAULT_PROMETHEUS_IMAGE
    mgr_images[
        mgr_prefix + 'alertmanager'
    ] = default_images.DEFAULT_ALERT_MANAGER_IMAGE
    mgr_images[mgr_prefix + 'graphana'] = default_images.DEFAULT_GRAFANA_IMAGE
    mgr_images[mgr_prefix + 'loki'] = default_images.DEFAULT_LOKI_IMAGE
    mgr_images[
        mgr_prefix + 'promtail'
    ] = default_images.DEFAULT_PROMTAIL_IMAGE
    mgr_images[
        mgr_prefix + 'node_exporter'
    ] = default_images.DEFAULT_NODE_EXPORTER_IMAGE
    mgr_images[mgr_prefix + 'haproxy'] = default_images.DEFAULT_HAPROXY_IMAGE
    mgr_images[
        mgr_prefix + 'keepalived'
    ] = default_images.DEFAULT_KEEPALIVED_IMAGE
    mgr_images[mgr_prefix + 'nvmeof'] = default_images.DEFAULT_NVMEOF_IMAGE
    mgr_images[
        mgr_prefix + 'snmp_gateway'
    ] = default_images.DEFAULT_SNMP_GATEWAY_IMAGE
    mgr_images[
        mgr_prefix + 'elasticsearch'
    ] = default_images.DEFAULT_ELASTICSEARCH_IMAGE
    mgr_images[
        mgr_prefix + 'jaeger_collector'
    ] = default_images.DEFAULT_JAEGER_COLLECTOR_IMAGE
    mgr_images[
        mgr_prefix + 'jaeger_agent'
    ] = default_images.DEFAULT_JAEGER_AGENT_IMAGE
    mgr_images[
        mgr_prefix + 'jaeger_query'
    ] = default_images.DEFAULT_JAEGER_QUERY_IMAGE
    mgr_images[mgr_prefix + 'smb'] = default_images.DEFAULT_SAMBA_IMAGE
    mgr_images[
        mgr_prefix + 'smbmetrics'
    ] = default_images.DEFAULT_SAMBA_METRICS_IMAGE
    mgr_images[mgr_prefix + 'nginx'] = default_images.DEFAULT_NGINX_IMAGE
    mgr_images[
        mgr_prefix + 'oauth2_proxy'
    ] = default_images.DEFAULT_OAUTH2_PROXY_IMAGE
    return mgr_images
