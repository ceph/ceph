					       ...
					       string& nspace)
{
  ...
  // create it.
  Object *o = new Object(this, oid, oset, l, truncate_size, truncate_seq, nspace);
			 ...
			 bool external_call)
{
  ...
  for (vector<ObjectExtent>::iterator ex_it = rd->extents.begin();
    ...
    Object *o = get_object(soid, oset, ex_it->oloc, ex_it->truncate_size, oset->truncate_seq, ex_it->nspace);
    touch_ob(o);
