...
def test_update_users_groups(smb_cfg):
    ...
    new_u = [
        {"name": "tc_duke", "password": "bcb7690188317ef17f54"},
        {"name": "tc_shelley", "password": "0177941ab5e569681b02"},
        {"name": "tc_gordon", "password": "ef97aec3a09c6de8cce8"},
        {"name": "tc_alex", "password": "085872411a373142a55c"},
    ]
