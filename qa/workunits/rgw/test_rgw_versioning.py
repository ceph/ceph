...
def main():
    ...
    key = 'olh-replay-race'
    old_version = bucket.Object(key).put(Body=b'a')['VersionId']
    ...
    try:
        ...
        connection.ObjectVersion(BUCKET_NAME, key, current_version).delete()
    ...
    assert bucket.Object(key).get()['VersionId'] == old_version
