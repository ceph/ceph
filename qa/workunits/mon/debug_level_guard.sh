...
function wait_for_revert() {
	...
	echo "ERROR: Timed out waiting for $subsys on $daemon to revert below $threshold"
	return 1
}
...
function wait_for_health_warning() {
	...
	echo "ERROR: Timed out waiting for $code in ceph health detail"
	ceph health detail
	return 1
}
...
function wait_for_health_clear() {
	...
	echo "ERROR: Timed out waiting for $code to clear"
	ceph health detail
	return 1
}
