    ...
    for client, properties in config['clients'].items():
        ...
        if ctx.rgw_cloudtier is not None:
            ...
            if client_rgw_config:
                ...
                s3tests_conf['s3 cloud']['allow_read_through'] = client_rgw_config.get('cloud_allow_read_through')
                s3tests_conf['s3 cloud']['read_through_restore_days'] = client_rgw_config.get('cloud_read_through_restore_days')
