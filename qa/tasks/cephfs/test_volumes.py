...
class TestCorrupptedSubvolumes(TestVolumesHelper):
    '''
    Test that certain cases like subvolume deletion and clone cancellations and
    deletions are handled well on a corrupoted subvolume as well.
    '''
    ...
    def test_clone_when_src_subvol_has_missing_UUID_dir(self):
        ...
        time.sleep(2)
        # ensure clone is stuck in in-progress state.
