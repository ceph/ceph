...
class TestPausePurgingTrash(TestVolumesHelper):
    '''
    Tests related to config "mgr/volumes/pause_purging_trash".
    '''

    conf_opt = 'mgr/volumes/pause_purging_trash'
    ...
    def test_when_false_subvol_is_trashed_and_also_purged(self):
        '''
        Test that when MGR config option mgr/volumes/pause_purging_trash is
        set to false, running "ceph fs subvolume rm" will move the subvolume
        to trash & also asynchronously purge it, that is delete it from trash.
        '''
        v = self.volname
        sv = 'sv1'
    ...
    def test_the_default_value(self):
        '''
        Test that MGR config option mgr/volumes/pause_purging_trash is false
        by default.
        '''
        v = self.volname
        sv = 'sv1'
