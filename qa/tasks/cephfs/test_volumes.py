...
class TestSubvolumes(TestVolumesHelper):
    ...
    def test_subvolume_info(self):
        ...
        self.assertEqual(subvol_info['source']['volume'], 'NA')
        self.assertEqual(subvol_info['source']['subvolume'], 'NA')
        self.assertEqual(subvol_info['source']['snapshot'], 'NA')
        self.assertEqual(subvol_info['source']['group'], 'NA')
        self.assertEqual(subvol_info['source']['subvolume_state'], 'NA')
    ...
    def test_subvolume_info_with_nondefault_group(self):
        '''
        Test that source subvolume's group is printed as NA when
...
class TestSubvolumeSnapshotClones(TestVolumesHelper):
    ...
    def test_clone_info_with_nondefault_group(self):
        '''
