...
This document addresses the first category.
...
email list (dev@ceph.io) and reviewed in the email list.
...
CodingStyle. Please adhere to these conventions.


Expectations regarding commit messages
--------------------------------------

The Ceph project has additional expectations regarding commit messages, based
on best practices developed over the years. Please see the sections "Separate
your changes", "Title of commit", "Fixes line(s)", and "Writing commit messages"
of the file "SubmittingPatches.rst" for these.
